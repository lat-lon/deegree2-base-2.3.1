...
xmlns:jdbc="http://www.deegree.org/jdbc" xmlns:deegree="http://www.deegree.org/wms" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <HTTP>
                            <Get>
                                <OnlineResource
                                	...
                                	<xsl:choose>
                                		<xsl:when
                                			test="DescribeLayer/DCPType/HTTP/Get/OnlineResource/@xlink:href">
                                			<xsl:attribute
                                				name="xlink:href">
                                				<xsl:value-of
                                					select="DescribeLayer/DCPType/HTTP/Get/OnlineResource/@xlink:href" />
                                			</xsl:attribute>
                                		</xsl:when>
                                		<xsl:otherwise>
                                			<xsl:attribute
