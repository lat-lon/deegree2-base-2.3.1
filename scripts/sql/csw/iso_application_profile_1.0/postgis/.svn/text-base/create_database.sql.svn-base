...
ALTER TABLE PublicationDate ADD CONSTRAINT PK_PublicationDate 
	PRIMARY KEY (ID) ;
	
ALTER TABLE DQ_QuantitativeResult ADD CONSTRAINT PK_DQ_QuantitativeResult 
	PRIMARY KEY (ID) ;
	
ALTER TABLE DQ_ConformanceResult ADD CONSTRAINT PK_DQ_ConformanceResult 
	PRIMARY KEY (ID) ;
