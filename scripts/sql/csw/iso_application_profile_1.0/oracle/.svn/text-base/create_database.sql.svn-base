...
CREATE TABLE DeliveryPoint ( 
	ID number(12),
	deliveryPoint varchar2(500)
) 
 NOLOGGING  NOMONITORING;

CREATE TABLE DQ_DataQuality ( 
	ID number(12),
	ScopeLevelCodeListValue varchar2(150),
...
CREATE TABLE EX_GeographicDescription ( 
	ID number(12),
	geographicIdentifierCode varchar2(150),
	FK_DataIdent number(12)
) 
 NOLOGGING  NOMONITORING;
...
CREATE TABLE EX_VerticalExtent ( 
	...
	description varchar2(4000),
	FK_DataIdent number(12),
	verticaldatum varchar2(4000)
) 
 NOLOGGING  NOMONITORING;

CREATE TABLE Facsimile ( 
	FK_Contact number(12),
	faxnumber varchar2(500),
	ID number(12)
) 
 NOLOGGING  NOMONITORING;
...
CREATE TABLE FAILEDREQUESTS ( 
	...
	CSWADDRESS varchar2(500),
	REPEAT number(12)
) 
 NOLOGGING  NOMONITORING;

CREATE TABLE FeatureTypes ( 
	localName varchar2(100),
...
CREATE TABLE FileIdentifier ( 
	ID number(12),
	fileidentifier varchar2(250)
) 
 NOLOGGING  NOMONITORING;

CREATE TABLE HierarchylevelCode ( 
	ID number(12),
	codeListValue varchar2(150),
	codeSpace varchar2(500)
) 
 NOLOGGING  NOMONITORING;
...
CREATE TABLE MD_AppSchemaInformation ( 
	ID number(12),
	fk_citation number(12),
	schemaLanguage varchar2(50),
	constraintLanguage varchar2(50),
	schemaAscii varchar2(50),
	graphicsFile64b varchar2(4000),
	softwareDevelFile64b varchar2(4000),
...
CREATE TABLE MD_DataIdentification ( 
	ID number(12),
	language varchar2(150),
	supplementalInformation varchar2(1000),
...
CREATE TABLE MD_Usage ( 
	ID number(12),
	specificUsage varchar2(500),
	fk_usercontactinfo number(12)
) 
 NOLOGGING  NOMONITORING;
...
CREATE TABLE SV_Parameter ( 
	...
	description varchar2(4000),
	optionality varchar2(20),
	repeatability CHAR,
	valuetype varchar2(150),
	ID number(12)
) 
 NOLOGGING  NOMONITORING;
