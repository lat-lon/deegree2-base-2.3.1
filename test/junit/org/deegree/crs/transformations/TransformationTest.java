//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/crs/transformations/TransformationTest.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 11228 $, $Date: 2008-04-17 12:24:37 +0200 (Thu, 17 Apr 2008) $
 * 
 */
public class TransformationTest extends TestCase {
    ...
    private String doAccuracyTest( Point3d sourcePoint, Point3d targetPoint, Point3d epsilons,
        ...
        if ( targetCRS.getDimension() == 3 ) {
            ...
            zString = createEpsilonString( zFail, pp.getZ(), targetPoint.z, epsilons.z,
                                           targetCRS.getCRS().getAxis()[2] );
        }
