//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/model/feature/FeatureTest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class FeatureTest extends TestCase {
    ...
    public void featureCollectionTesting( String Id, Feature[] features, FeatureCollection fc ) {
        ...
        for ( int i = 0; i < features.length; i++ ) {
            ...
            Object[] featObjecProps = features[i].getProperties();
            Object[] fcFeatObjecProps = features[i].getProperties();
            ...
            for ( int j = 0; j < featObjecProps.length; j++ ) {
                ...
                Object value1 = features[i].getProperties( j )[0];
                Object value2 = fcFeatures[i].getProperties( j )[0];
