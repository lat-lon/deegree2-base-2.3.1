//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/model/spatialschema/GMLTest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Test case for Web Feature Service (WFS).
 * 
...
public class GMLTest extends TestCase {
    ...
    private static ILogger LOG = LoggerFactory.getLogger( GMLTest.class );

    public static Test suite() {

        return new TestSuite( GMLTest.class );
    ...
    /*
     * Tests wether the conversion <gml:MultiLineString> into a MultiCurve instance is correctly
     * made
     */
    public void testWrapMultiLineString() {
    ...
    public void testWrapMultiPolygon() {
        ...
        /*
         * The Interiors of the Polygons defined above Polygons[0] has no Interior -> null
         * Polygon[1] has 1 Interior
         */
    ...
    /*
     * Test wether the <tt>MultiPoint</tt> object mpt contains all Points defined in 2-dimensional
     * array points @param mpt @param points
     */
    ...
    /*
     * Test wether the <tt>Curve</tt> object cv contains all Positions defined in 2-dimensional
     * array points @param cv @param points
     */
    ...
    /*
     * Test wether curve[i] of the <tt>MultiCurve</tt>[ object mcv contains all Points defined
     * points[i] @param mpt @param points
     */
    ...
    /*
     * Test wether the exterior of the <tt>Surface</tt> object surface contains the Postions
     * defined in ths 2-dimensional array exterior and wether the interiors[i] contains the Position
     * of interiors[i] @param mpt @param exterior @param interiors
     * 
     */
    ...
    /*
     * Test wether surfExtPosition contains alls Positions defined in exterior @param exterior
     * @param surfExtPosition
     * 
     */
    ...
    /*
     * Test wether surfInteriors contains all Positions defined in ineterior @param interior @param
     * surfInteriors
     * 
     */
    ...
    /*
     * Test wether the exterior of suface[i] of the <tt>MultiSurface</tt> object msf contains all
     * Positions in exterior[i] and wether its interiors contains all Positions in interiors[i]
     * @param msf @param exteriors @param interiors
     */
    ...
    /*
     * Tests wether the conversion MultiCurve instance into a <gml:MultiLineString> is correctly
     * made
     */
    ...
    /*
     * Tests wether the conversion Envelope instance into a <gml:Box> is correctly made and wether
     * the conversion Envelope instance into a <gml:Envelope> is correctly made
     */
    ...
    public void testWrapCurveAsCurve()
        ...
        URL inputURL = GMLTest.class.getResource( "curve.xml" );
    ...
    public void testWrapSurfaceAsSurface()
        ...
        URL inputURL = GMLTest.class.getResource( "surface.xml" );
        XMLFragment xml = new XMLFragment();
        xml.load( inputURL );
    ...
    public void testWrapSurfaceAsSurface2()
        ...
        URL inputURL = GMLTest.class.getResource( "surface2.xml" );
        XMLFragment xml = new XMLFragment();
        xml.load( inputURL );
        Surface surface = GMLGeometryAdapter.wrapSurfaceAsSurface( xml.getRootElement(), null );
        assertNotNull( surface );
    ...
    public void testWrapSurfaceAsSurface3()
        ...
        URL inputURL = GMLTest.class.getResource( "surface3.xml" );
        XMLFragment xml = new XMLFragment();
        xml.load( inputURL );
        Surface surface = GMLGeometryAdapter.wrapSurfaceAsSurface( xml.getRootElement(), null );
        assertNotNull( surface );
    ...
    public void testMultiCurveAsMultiCurve()
        ...
        URL inputURL = GMLTest.class.getResource( "multiCurve.xml" );
        XMLFragment xml = new XMLFragment();
        xml.load( inputURL );
    ...
    public void testMultiSurfaceAsMultiSurface()
        ...
        URL inputURL = GMLTest.class.getResource( "multiSurface.xml" );
        XMLFragment xml = new XMLFragment();
        xml.load( inputURL );
