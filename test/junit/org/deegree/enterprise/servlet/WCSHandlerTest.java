//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/enterprise/servlet/WCSHandlerTest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WCSHandlerTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite( WCSHandlerTest.class );
    }
    ...
    protected void setUp()
                            throws Exception {
        super.setUp();
        fail( "Not testing Setting up wcs handler test -- fixme" );
    ...
    public void testPerformGetCapabilities()
        ...
        // AllTests.LOG.logDebug( responseAsXml );
    ...
    public void testPerformGetCapabilitiesSection()
                            throws OGCWebServiceException, ServiceException, IOException, SAXException {
        fail( "Not testing GetCapabilities Section -- fixme" );
        // WCSHandler handler = new WCSHandler();
        // assertNotNull( handler );
        // OGCWebServiceRequest request = new WCSGetCapabilities(
        // this.toString(),
        // "1.0.0",
        // "0",
        // new String[] { "/WCS_Capabilities/Service" },
        // null );
        // HttpServletResponse response = new MockHttpServletResponse( writer );
        // handler.perform( request, response );
        // String responseAsXml = writer.toString();
    ...
    public void testGetService()
                            throws ServiceException {
        fail( "Not testing GetService -- fixme" );
        // WCSHandler handler = new WCSHandler();
