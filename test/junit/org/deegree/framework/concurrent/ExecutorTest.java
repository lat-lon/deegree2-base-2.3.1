//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/framework/concurrent/ExecutorTest.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 */
public class ExecutorTest extends TestCase implements ExecutionFinishedListener, Callable<Object> {
    ...
    public void testSynchronousCallsWithTimeout()
        ...
        for ( ExecutionFinishedEvent obj : results ) {
            try {
     ...
     * @param finishedEvent
     */
    public void executionFinished( ExecutionFinishedEvent finishedEvent ) {
        Object resultValue;
        try {
