//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/ogcwebservices/wass/wss/WSServiceTest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WSServiceTest extends TestCase {
    ...
    protected void setUp()
        ...
        super.setUp();
        try {
            LOG.logInfo( "Setting up WSS... needs to be fixed" );
            fail();
