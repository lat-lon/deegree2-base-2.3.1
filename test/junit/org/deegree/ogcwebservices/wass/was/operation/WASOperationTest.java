//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/org/deegree/ogcwebservices/wass/was/operation/WASOperationTest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WASOperationTest extends TestCase {
    ...
    public void testGetSessionKVP()
                            throws Exception {
        fail( "Not testing GetSessionKVP -- fixme" );
    ...
    public void testCloseSessionKVP()
                            throws Exception {
        fail( "Not testing CloseSessionKVP -- fixme" );
        // HashMap<String, String> map = new HashMap<String, String>();
        // map.put( "SERVICE", "WAS" );
        // map.put( "VERSION", "1.0.0" );
    ...
    public void testGetCapabilitiesKVP()
                            throws Exception {
        fail( "Not testing GetCapabilities KVP -- fixme" );
        // HashMap<String, String> map = new HashMap<String, String>();
        // map.put( "SERVICE", "WAS" );
        // map.put( "VERSION", "1.0.0" );
