//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/test/junit/alltests/Configuration.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public final class Configuration {
    ...
    /* SOS specific configuration */
    public static final String SOS_CONFIGURATION_FILE = Messages.getString( "Configuration.sos.configuration" );
    ...
    public static final URL getSOSBaseDir()
                            throws MalformedURLException {
        return new URL( getResourceDir(), Messages.getString( "Configuration.sos.basedir" ) );
    }

    public static URL getWFSURL()
                            throws MalformedURLException {
        return new URL( PROTOCOL, HOST, PORT, WFS_WEB_CONTEXT );
    }

    public static URL getCSWURL()
                            throws MalformedURLException {
        return new URL( PROTOCOL, HOST, PORT, CSW_WEB_CONTEXT );
    }
    ...
    public static URL getSOSConfigurationURL()
                            throws MalformedURLException {
        return new URL( getSOSBaseDir(), SOS_CONFIGURATION_FILE );
    }
