//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/owscommon_1_1_0/CommonsDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * <code>CommonsDocument</code> supplies helper methods for all common ows (version 1.1.0) xml
 * elements.
 * 
...
public class CommonsDocument extends XMLFragment {
    ...
    protected List<Operation> parseOperations( List<Element> operationElements )
        ...
        for ( Element op : operationElements ) {
            /**
             * from owsOperationsMetadata<br/> Unordered list of Distributed Computing Platforms
             * (DCPs) supported for this operation. At present, only the HTTP DCP is defined, so
             * this element will appear only once.
             */
            ...
            List<Pair<String, String>> metadataAttribs = parseMetadatas( getElements( op, PRE_OWS + "MetaData",
                                                                                      nsContext ) );
     ...
     * 
     * @param getOrPost
     * @return the pair containing the xlink, list&lt;contraint&gt;. or <code>null</code> if
     *         attribute and elements were not found.
     * @throws XMLParsingException
     */
     ...
     * @param domainType
     *            to parse
     * @return a bean representation of the domainType or <code>null</code> if given element is
     *         <code>null</code>.
     * @throws XMLParsingException
     */
    protected DomainType parseDomainType( Element domainType )
        ...
        List<Pair<String, String>> metadataAttribs = parseMetadatas( getElements( domainType, PRE_OWS + "MetaData",
                                                                                  nsContext ) );
     ...
     *            to be parsed.
     * @return a List of pairs of optional &lt;xlink:href, about&gt; attributes, or an empty list
    ...
    protected List<Pair<String, String>> parseMetadatas( List<Element> metadataElements ) {
        ...
        List<Pair<String, String>> result = new ArrayList<Pair<String, String>>( metadataElements.size() );
        for ( Element mde : metadataElements ) {
            Pair<String, String> md = parseMetadata( mde );
            if ( md != null ) {
                result.add( md );
            }
        }
    ...
    protected Pair<String, String> parseMetadata( Element metadataElement ) {
        ...
        if ( metadataAbout != null || metadataHref != null ) {
            return new Pair<String, String>( metadataHref, metadataAbout );
        }
        return null;
    }

    /**
     * Parses the domain metadata type and it's reference attribute and puts them in a pair, like
     * name, reference, which may be null
     * 
     * @param domainMDElements
     * @return a list of pairs containing the values or <code>null</code> if given list is
     *         <code>null</code> or it does not contain any domain elements value.
     * @throws XMLParsingException
     */
    ...
    /**
     * Parses the domain metadata type and it's reference attribute and puts them in a pair, like
     * name, reference, the latter may be null
     * 
     * @param domainMDElement
     *            to parse
     * @return a pair containing the values or <code>null</code> if given element is null or it
     ...
     *            to be parsed.
     * @return the {@link BasicIdentification} bean representation or <code>null</code> if the
     *         given element is <code>null</code>.
     * @throws XMLParsingException
    ...
    protected BasicIdentification parseBasicIdentificationType( Element basicIdentificationType )
        ...
        List<Pair<String, String>> metadatas = parseMetadatas( getElements( basicIdentificationType, PRE_OWS
                                                                                                     + "Metadata",
                                                                            nsContext ) );
     ...
     * @return a &lt;value, codeSpace&gt; pair or <code>null</code> if the given element is
     *         <code>null</code> or if the identifier has no value and codeSpace.
     * @throws XMLParsingException
     */
