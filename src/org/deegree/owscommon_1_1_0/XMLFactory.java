//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/owscommon_1_1_0/XMLFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * The <code>XMLFactory</code> is a convenience class, which exports ows-common 1.1.0 beans to
 * their xml representation. representation.
 * 
...
public class XMLFactory extends org.deegree.ogcbase.XMLFactory {
    ...
    /**
     * Will create an XMLFragment which holds the ows:OperationResponse as the root element, values
     * from the given manifest will be appended.
     * 
    ...
    /**
     * Exports the manifest type to its dom-xml representation. If either one of the params is
    ...
    /**
     * Appends the given reference to the given root. If either one of the params is
     * <code>null</code> nothing is done.
     * 
     * @param root
     *            to append too.
    ...
    /**
     * Appends the given basicIdentification to the given root. If either one of the params is
     * <code>null</code> nothing is done.
     * 
     * @param root
     *            to append too.
    ...
    /**
     * Appends the given titles to the given root. If either one of the params is <code>null</code>
     * nothing is done.
     * 
     * @param root
     *            to append too.
    ...
    /**
     * Appends the given abstracts to the given root. If either one of the params is
     * <code>null</code> nothing is done.
     * 
     * @param root
     *            to append too.
    ...
    /**
     * Appends the given keywords to the given root. If either one of the params is
     * <code>null</code> nothing is done.
     * 
     * @param root
     *            to append too.
    ...
    /**
     * @param root
     *            (usually a serviceContact) to export to if <code>null</code> nothing will be
     *            done.
     * @param contactInfo
     *            to append if <code>null</code> nothing will be done (optional).
     */
    ...
    protected void appendOperations( Element root, List<Operation> operations )
        ...
        for ( Operation operation : operations ) {
            ...
            if ( operation.getMetadataAttribs() != null && operation.getMetadataAttribs().size() > 0 ) {
                for ( Pair<String, String> attrib : operation.getMetadataAttribs() ) {
                    if ( attrib != null ) {
                        Element metadata = appendElement( opElement, OWSNS_1_1_0, PRE + "Metadata" );
                        if ( attrib.first != null ) {
                            metadata.setAttributeNS( XLNNS.toASCIIString(), XLINK_PREFIX + ":href", attrib.first );
                        }
                        if ( attrib.second != null ) {
                            metadata.setAttribute( "about", attrib.second );
                        }
                    }
                }
            }
    ...
    /**
     * Appends the given metadata attributes to the given root. If either one of the params is
     * <code>null</code> nothing is done.
     * 
     * @param root
     *            to append too.
     ...
     */
    protected void appendMetadataAttribs( Element root, List<Pair<String, String>> metadatasAttribs ) {
        if ( root != null && metadatasAttribs != null ) {
            for ( Pair<String, String> attrib : metadatasAttribs ) {
                if ( attrib != null ) {
    ...
    /**
     * Appends an xml representation of an <code>OGCWebServiceException</code> to the given
     * <code>Element</code>. If either one is <code>null</code> this method just returns.
     * 
     * @param root
