//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/owscommon_1_1_0/ManifestDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ManifestDocument extends CommonsDocument {
     ...
     *            to be parsed
     * @return the bean representation or <code>null</code> if the given element is
     *         <code>null</code>.
     * @throws XMLParsingException
    ...
    protected Reference parseReferenceType( Element referenceElement )
        ...
        List<Pair<String, String>> metadatas = parseMetadatas( getElements( referenceElement, PRE_OWS + "Metadata",
                                                                            nsContext ) );
