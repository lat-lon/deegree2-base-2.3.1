//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/owscommon_1_1_0/Reference.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Reference {
    ...
    public Reference( String hrefAttribute, String roleAttribute, String typeAttribute,
                      Pair<String, String> identifier, List<String> abstracts, String format,
                      List<Pair<String, String>> metadatas ) {
