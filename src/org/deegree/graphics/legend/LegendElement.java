//$HeadURL: svn+ssh://developername@svn.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/legend/LegendElement.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * The implements the basic legend element. a legend element may has a label that can be set to
 * eight positions relative to the legend graphic. A <tt>LegendElement</tt> can be activated or
 * deactivated. It depends on the using application what effect this behavior will have.
 * <p>
 * <tt>LegendElement</tt>s can be collected in a <tt>LegendElementCollection</tt> which also is
 * a <tt>LegendElement</tt> to group elements or to create more complex elements.
 * <p>
...
public class LegendElement {
    ...
    /**
     * returns the label set to <tt>LegendElement</tt>. If no label is set, the method returns
     * <tt>null</tt>
     * 
    ...
    /**
     * sets the orientation of the label of the <tt>LegendElement</tt>. A label can have an
     * orientation from -90� to 90� expressed in radians, where 0� is horizontal
     * 
     * @param orientation
     */
    ...
    /**
     * returns the current orientation of the label of the <tt>LegendElement</tt> in radians. If
     * the element hasn't a label <tt>Double.NEGATIVE_INFINITY</tt> will be returned.
     * 
    ...
    /**
     * returns the placement of the label relative to the legend symbol. If the element hasn't a
     * label <tt>LegendElement.LP_NOLABEL</tt> will be returned. Otherwise possible values are:
     * <ul>
     * <li>LP_TOPCENTER
     * <li>LP_TOPLEFT
     * <li>LP_TOPRIGHT
     ...
     * @return the 3-dimensional INT-Array contains [0] the width of the string, [1] the ascent and
     *         [2] the descent.
     */
