//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/ParameterValueType.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ParameterValueType implements Serializable, Marshallable {
    ...
    /**
     * Returns the actual <tt>String</tt> value of this object. Expressions are evaluated
     * according to the given <tt>Feature</tt> -instance.
     * <p>
     * 
     * @param feature
