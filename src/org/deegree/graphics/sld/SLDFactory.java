//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/SLDFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SLDFactory {
    ...
    /**
     * Creates a <tt>StyledLayerDescriptor</tt>-instance from a SLD document read from the passed
     * URL
     * 
     * @param url
     * @return the SLD bean
    ...
    /**
     * <code>TresholdsBelongTo</code> enumerates values possibly belonging to
     * <code>ThreshholdsBelongToType</code>.
     * 
