//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/RasterSymbolizer.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class RasterSymbolizer extends AbstractSymbolizer {
    ...
    public boolean scaleValid( double scale ) {
        return ( scaleSet && min <= scale && max >= scale ) || !scaleSet;
    }
