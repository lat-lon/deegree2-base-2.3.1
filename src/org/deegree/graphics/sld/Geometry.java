//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/Geometry.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * feature type that is used in the containing FeatureStyleType is used. The precise meaning of
 * default geometry property is system-dependent. Most frequently, feature types will have only a
 * single geometry property.
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 * 
...
public class Geometry implements Marshallable {
     ...
     * computing a geometry from references or literals. This enbales the calling client to submitt
     * the geometry to be rendered by the WMS directly. (This is not part of the SLD XML-schema)
     * 
     * @return the Geometry
     * 
     */
