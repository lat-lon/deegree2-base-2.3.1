//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/Stroke.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * @version $Revision: 13555 $ $Date: 2008-08-11 10:49:28 +0200 (Mo, 11. Aug 2008) $
 */
...
public class Stroke extends Drawing implements Marshallable {
     ...
     * @param graphicFill
     */
    protected Stroke( HashMap<String, Object> cssParams, GraphicStroke graphicStroke, GraphicFill graphicFill ) {
