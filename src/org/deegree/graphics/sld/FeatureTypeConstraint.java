//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/FeatureTypeConstraint.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * A FeatureTypeConstraint element is used to identify a feature type by well-known name, using the
...
public class FeatureTypeConstraint implements Marshallable {
    ...
    public String exportAsXML() {
        ...
        if ( featureTypeName.getNamespace() == null ) {
            ...
            sb.append( featureTypeName.getLocalName() );
        } else {
