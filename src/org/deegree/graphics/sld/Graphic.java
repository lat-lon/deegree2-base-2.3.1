//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/Graphic.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 11029 $, $Date: 2008-04-11 13:04:21 +0200 (Fri, 11 Apr 2008) $
 */
public class Graphic implements Marshallable {
    ...
    public BufferedImage getAsImage( Feature feature )
        ...
        if ( intSizeX <= 0 || intSizeY <= 0 || intSizeX > 1000 || intSizeY > 1000 ) {
            ...
            System.out.println( intSizeX + " - " + intSizeY );
            intSizeX = 1;
            intSizeY = 1;
        }
