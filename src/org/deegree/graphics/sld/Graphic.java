//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/Graphic.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12991 $, $Date: 2008-07-16 15:09:27 +0200 (Mi, 16. Jul 2008) $
 */
public class Graphic implements Marshallable {
     ...
     */
    protected Graphic( Object[] marksAndExtGraphics, ParameterValueType opacity, ParameterValueType size,
    ...
    /**
     * The Size element gives the absolute size of the graphic in pixels encoded as a floating-point
    ...
    public BufferedImage getAsImage( Feature feature )
        ...
        g.rotate( toRadians( getRotation( feature ) ), intSizeX >> 1, intSizeY >> 1 );
