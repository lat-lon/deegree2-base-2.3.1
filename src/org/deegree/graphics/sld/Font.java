//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/Font.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Font implements Marshallable {
    ...
    private Map<String, Object> cssParams = null;
     ...
     *                  <tt>CssParameters</tt>
     */
    protected Font( Map<String, Object> cssParams ) {
    ...
    public String exportAsXML() {
        ...
        sb.append( "<Font>" );
        Iterator<Object> iterator = cssParams.values().iterator();
