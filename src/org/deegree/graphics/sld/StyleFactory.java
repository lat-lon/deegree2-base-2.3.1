//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/StyleFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class StyleFactory {
    ...
    /**
     * creates a <tt>ParameterValueType</tt> instance with an array of <tt>Expression</tt> s as
     * value
     * 
     * @param expressions
     * 
    ...
    /**
     * create a default Stroke that black, 1 pixel width, complete opaque, with round linejoin and
     * square line cap
     * 
     ...
     *            the width of the line
     * @param opacity
     *            the opacity or <I>see throughness </I> of the line, 0 - is transparent, 1 is
     *            completely drawn
     * @param lineJoin
     *            the type of join to be used at points along the line
     * @param lineCap
    ...
    /**
     * creates a <tt>LinePlacement</tt> with a user defined distance between the labels and the
     * lines. A positive value indicates a position above the line, a negative value indicates a
     * position below. The line width is asumed to be 2 pixel and the gap between the labels is set
     * to factor 10 of the label width.
     * 
     * @param offset -
    ...
    /**
     * creates a <tt>LinePlacement</tt> with a relative position of the label according to the
     * line the lines. The line width is asumed to be 2 pixel and the gap between the labels is set
     * to factor 10 of the label width.
     * 
     * @param position
    ...
    /**
     * creates a style with name 'defaultPoint' for rendering point geometries. The style contains
     * 1..n rules depending on the value range and the number of steps within it. So it is possible
     * to create a style that creates different rendering depending on the value of one feature
     * attribute.
     * <p>
     * there will be a linear interpolation between colors, size and width of the first and the last
     * rule considering the number of passed steps (rules)
     * 
     * @param wellKnownNames -
     *            list of well known names of the mark. the first field will be assigned to the
     *            starting rule the last to the ending rule.
     ...
     * @param numberOfSteps -
     *            number of steps used for the interpolation between first and last value. It is
     *            identical with the number of rules that will be created.
     * 
     * @return the style created
     */
    ...
    /**
     * creates a style with name 'defaultLine' for rendering line geometries. The style contains
     * 1..n rules depending on the value range and the number of steps within it. So it is possible
     * to create a style that creates different rendering depending on the value of one feature
     * attribute.
     * <p>
