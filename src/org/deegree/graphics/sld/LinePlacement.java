//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/sld/LinePlacement.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class LinePlacement implements Marshallable {
    ...
    /**
     * returns the perpendicular offset as
     * 
     * @see ParameterValueType
     * @return
     */
