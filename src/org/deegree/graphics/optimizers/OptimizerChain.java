//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/optimizers/OptimizerChain.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class OptimizerChain extends AbstractOptimizer {
    ...
    private ArrayList<AbstractOptimizer> optimizers = new ArrayList<AbstractOptimizer>();
    ...
    /**
     * Constructs a new <tt>OptimizerChain</tt> that contains the submitted <tt>Optimizer</tt>
     * instances.
     * <p>
     * 
     * @param optimizers
    ...
    /**
     * Performs the optimization. Calls the optimize-method of all contained <tt>Optimizer</tt>
