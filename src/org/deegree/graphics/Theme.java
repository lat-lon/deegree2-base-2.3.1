//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/Theme.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Theme {
    ...
    /**
     * A selector is a class that offers methods for selecting and deselecting single
    ...
    /**
     * adds an eventcontroller to the theme that's reponsible for handling events that targets the
     * theme.
     */
