//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/MapView.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class MapView {
    ...
    /**
     * returns the BoundingBox (Envelope) of the MapView. This isn't nessecary the BoundingBox of
