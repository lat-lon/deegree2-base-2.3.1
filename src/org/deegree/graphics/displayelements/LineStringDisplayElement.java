//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/LineStringDisplayElement.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * {@link DisplayElement} that encapsulates a linestring or multi-linestring geometry and a
 * {@link LineSymbolizer}.
 * <p>
