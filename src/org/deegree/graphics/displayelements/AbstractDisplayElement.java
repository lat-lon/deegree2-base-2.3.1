//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/AbstractDisplayElement.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * A <code>DisplayElement</code> is associated to one feature that may have a geometry property or
 * not (this is the common case).
 * 
...
abstract class AbstractDisplayElement implements DisplayElement, Serializable {
    ...
    /**
     * Returns whether the <code>DisplayElement</code> should be painted at the current scale or
     * not.
     */
