//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/LabelDisplayElement.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * The graphical (say: screen) representations of this <tt>DisplayElement</tt> are <tt>Label</tt>-instances.
 * These are generated either when the <tt>paint</tt>-method is called or assigned externally
 * using the <tt>setLabels</tt>- or <tt>addLabels</tt>-methods.
 * </p>
 * 
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @author <a href="mailto:mschneider@lat-lon.de">Markus Schneider</a>
 * @version $Revision: 10593 $ $Date: 2008-03-17 14:35:32 +0100 (Mon, 17 Mar 2008) $
 */
...
public class LabelDisplayElement extends GeometryDisplayElement implements DisplayElement, Serializable {
     ...
     * have been assigned externally, these labels are used, else <tt>Label</tt>-instances are
     * created automatically using the <tt>LabelFactory</tt>.
     * <p>
     * 
     * @param g
    ...
    /**
     * Sets the <tt>Label</tt> representations that are to be considered when the
     * <tt>LabelDisplayElement</tt> is painted to the view.
     * 
     * @param labels
     */
