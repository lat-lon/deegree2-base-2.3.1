//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/RotatedLabel.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This is a rotated label with style information and screen coordinates, ready to be rendered to
 * the view.
 * <p>
 * 
...
class RotatedLabel implements Label {
     ...
     * @param anchorPoint
     * @param displacement
     * @deprecated Use {@link #RotatedLabel(String,Font,Color,LineMetrics,Feature,Halo,int,int,int,int,double,double[])} instead
     */
    @Deprecated
    RotatedLabel( String caption, Font font, Color color, LineMetrics metrics, Feature feature, Halo halo, int x,
                  int y, int w, int h, double rotation, double anchorPoint[], @SuppressWarnings("unused")
                double[] displacement ) {
                    this( caption, font, color, metrics, feature, halo, x, y, w, h, rotation, anchorPoint );
                }
     ...
     */
    RotatedLabel( String caption, Font font, Color color, LineMetrics metrics, Feature feature, Halo halo, int x,
                  int y, int w, int h, double rotation, double anchorPoint[] ) {
