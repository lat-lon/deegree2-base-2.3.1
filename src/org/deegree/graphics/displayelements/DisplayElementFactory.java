//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/DisplayElementFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10535 $, $Date: 2008-03-10 11:13:39 +0100 (Mon, 10 Mar 2008) $
 */
public class DisplayElementFactory {
    ...
    public DisplayElement[] createDisplayElement( Object o, UserStyle[] styles )
        ...
        if ( o instanceof Feature ) {
            ...
            for ( UserStyle style : styles ) {
                if ( style == null ) {
                    list.add( buildRasterDisplayElement( (GridCoverage) o, new RasterSymbolizer() ) );
                    continue;
                }
    ...
    /**
     * Builds a {@link DisplayElement} using the given {@link Feature} or {@link GridCoverage} and
     * {@link Symbolizer}.
     * 
     * @param o
     ...
     *            style information
     * @throws IncompatibleGeometryTypeException
     *             if the geometry property is not a <code>Surface</code> or
     ...
     *            style information
     * @throws IncompatibleGeometryTypeException
     *             if the geometry property is not a <code>Point</code>, a <code>Surface</code>
     *             or <code>MultiSurface</code>
