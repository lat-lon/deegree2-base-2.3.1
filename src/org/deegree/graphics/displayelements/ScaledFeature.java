//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/ScaledFeature.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12090 $, $Date: 2008-06-03 10:05:10 +0200 (Di, 03. Jun 2008) $
 */
public class ScaledFeature implements Feature {
    ...
    /**
     * sets the features scale. Expected is the scale denominator as defined by OGC SLD
     * specification
     * 
     * @param scale
     */
