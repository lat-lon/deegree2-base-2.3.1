//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/graphics/displayelements/HorizontalLabel.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This is a horizontal label with style information and screen coordinates, ready to be rendered to
 * the view.
 * <p>
 * 
