//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/drm/SecurityTransaction.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10598 $, $Date: 2008-03-17 15:17:38 +0100 (Mon, 17 Mar 2008) $
 */
public class SecurityTransaction extends SecurityAccess {
    ...
    /**
     * Deletes all data from the underlying <code>Registry</code> and sets the default objects
     ...
     * <li>rights for the owner role are set up; creator has delete, update and grant rights on the
     * group, administrator role gets these right, too
     * </ul>
     * 
     ...
     * <li>rights for the owner role are set up; creator has delete, update and grant rights on the
     * role, administrator role gets these right, too
     * </ul>
     * 
     ...
     * <li>rights for the owner role are set up; creator has delete, update and grant rights on the
     * object, administrator role gets these right, too
     * </ul>
     * 
     * @param type
     * @param name
     ...
     * <li>rights for the owner role are set up; creator has delete, update and grant rights on the
     * user, administrator role gets these right, too
     * </ul>
     * 
     ...
     * 
     * NOTE: Only performed if the acting user has the 'grant'-right for all the groups that are
     * requested to be added / removed.
     * 
     * @param group
     * @param newGroups
     * @throws GeneralSecurityException
     ...
     * 
     * NOTE: Only performed if the acting user has the 'update'-right on the role and the
     * 'grant'-right on the securable object.
     * 
     * @param object
     * @param role
     * @param rights
     ...
     * 
     * NOTE: Only performed if the acting user has the 'update'-right on the role and the
     * 'grant'-right on the securable objects.
     * 
     * @param objects
     * @param role
     * @param right
    ...
    /**
     * Adds the specified <code>Rights</code> on the passed object to the passed role. If they are
    ...
    /**
     * Removes all rights of the specified types that the role may have on the given
    ...
    /**
     * Sets the users to be associated with the given role (DIRECTLY, i.e. not via group
     * memberships).
     * 
