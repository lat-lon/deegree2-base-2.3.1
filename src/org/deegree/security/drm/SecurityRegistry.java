//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/drm/SecurityRegistry.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This is an interface for datastores that are able to stores the following object types and their
 * relations:
 * <ul>
 * <li><code>User</code>
 * <li><code>Group</code>
...
public interface SecurityRegistry {
    ...
    /**
     * Signals the <code>Registry</code> that the current transaction ends. Changes made during
     * the transaction are now made persistent.
     * 
     * @param transaction
     * 
     * @throws GeneralSecurityException
    ...
    /**
     * Signals the <code>Registry</code> that the transaction shall be aborted. Changes made by
    ...
    /**
     * Deletes all data from the <code>Registry</code> and sets the default objects (SEC_ADMIN
     * user, role and group) and standard rights and privileges.
     * 
     * @param transaction
     * @throws GeneralSecurityException
     */
     ...
     * DIRECTLY (SecurityAccess securityAccess, i.e. not via group memberships) with a given
     * <code>Role</code>.
     * 
     * @param securityAccess
     * @param role
    ...
    /**
     * Retrieves all <code>User</code> s from the <code>Registry</code> belong to the given
     * <code>Group</code>.
     * 
     * @param securityAccess
     * @param group
    ...
    /**
     * Retrieves all <code>Group</code> s from the <code>Registry</code> belong to the given
     * <code>Group</code>.
     * 
     * @param securityAccess
     * @param group
    ...
    /**
     * Sets the <code>Groups</code> s that a given <code>Group</code> is member of DIRECTLY
    ...
    /**
     * Retrieves all <code>Role</code> s from the <code>Registry</code> that have a certain
     * namespace.
     * 
     * @param securityAccess
     * @param ns
     ...
     * only used internally (these end with a $ symbol);
     * 
     * @param securityAccess
     * @return the roles
     * 
    ...
    /**
     * Retrieves all <code>Role</code> s from the <code>Registry</code> that are associated with
     * a given <code>Group</code> DIRECTLY (i.e. not via group memberships).
     * 
     * @param securityAccess
     * @param group
     * @return the roles
     ...
     * 
     * @throws GeneralSecurityException
     *             this is an <code>UnknownException</code> if the <code>SecuredObject</code> is
     ...
     * associated with a given <code>Role</code>.
     * 
     * @param securityAccess
     * @param role
     ...
     * 
     * @throws GeneralSecurityException
     *             this is a <code>DuplicateException</code> if the <code>RightType</code>
     *             already existed
     */
     ...
     * 
     * @throws GeneralSecurityException
     *             this is an <code>UnknownException</code> if the <code>RightType</code> is not
