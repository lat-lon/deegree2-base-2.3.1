//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/drm/SQLRegistry.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public final class SQLRegistry implements SecurityRegistry {
    ...
    public User getUserByName( SecurityAccess securityAccess, String name )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_USERS.ID,SEC_USERS.PASSWORD,SEC_USERS.FIRSTNAME,SEC_USERS.LASTNAME,SEC_USERS.EMAIL "
    ...
    public User[] getAllUsers( SecurityAccess securityAccess )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_USERS.ID,SEC_SECURABLE_OBJECTS.NAME,SEC_USERS.PASSWORD,SEC_USERS.FIRSTNAME,SEC_USERS.LASTNAME,SEC_USERS.EMAIL "
                                          + "FROM SEC_USERS,SEC_SECURABLE_OBJECTS "
    ...
    public User[] getUsersWithRole( SecurityAccess securityAccess, Role role )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_USERS.ID,SEC_SECURABLE_OBJECTS.NAME,SEC_USERS.PASSWORD,SEC_USERS.FIRSTNAME,SEC_USERS.LASTNAME,"
                                          + "SEC_USERS.EMAIL "
    ...
    public Group getGroupById( SecurityAccess securityAccess, int id )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_SECURABLE_OBJECTS.NAME,SEC_SECURABLE_OBJECTS.TITLE "
                                          + "FROM SEC_GROUPS,SEC_SECURABLE_OBJECTS "
    ...
    public Group[] getAllGroups( SecurityAccess securityAccess )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_GROUPS.ID,SEC_SECURABLE_OBJECTS.NAME,SEC_SECURABLE_OBJECTS.TITLE "
                                          + "FROM SEC_GROUPS,SEC_SECURABLE_OBJECTS "
    ...
    public Role getRoleByName( SecurityAccess securityAccess, String name )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_ROLES.ID " + "FROM SEC_ROLES,SEC_SECURABLE_OBJECTS "
    ...
    public SecuredObject getSecuredObjectByName( SecurityAccess securityAccess, String name, String type )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_SECURED_OBJECTS.ID,SEC_SECURED_OBJECT_TYPES.ID, "
    ...
    public SecuredObject getSecuredObjectById( SecurityAccess securityAccess, int id )
        ...
        try {
            pstmt = con.prepareStatement( "SELECT SEC_SECURED_OBJECTS.FK_SECURED_OBJECT_TYPES,SEC_SECURABLE_OBJECTS.NAME,"
                                          + "SEC_SECURABLE_OBJECTS.TITLE "
    ...
    public Privilege registerPrivilege( SecurityTransaction transaction, String name )
        ...
        try {
            pstmt = transactionalConnection.prepareStatement( "INSERT INTO SEC_PRIVILEGES (ID, NAME) VALUES (?,?)" );
            pstmt.setInt( 1, id );
    ...
    public RightType registerRightType( SecurityTransaction transaction, String name )
        ...
        try {
            pstmt = transactionalConnection.prepareStatement( "INSERT INTO SEC_RIGHTS (ID, NAME) VALUES (?,?)" );
            pstmt.setInt( 1, id );
            pstmt.setString( 2, name );
            pstmt.executeUpdate();
            pstmt.close();
    ...
    public Service getServiceByAddress( SecurityAccess access, String address )
        ...
        Service service;
        try {
            pstmt = con.prepareStatement( "select sec_services.id,sec_services.address,sec_services.title,sec_services.type,sec_services_objects.name,sec_services_objects.title from "
                                          + " sec_services,sec_services_objects "
                                          + "where sec_services.id = sec_services_objects.serviceid and "
                                          + "sec_services.address = ?" );
    ...
    public LinkedList<Service> getAllServices( SecurityAccess access )
        ...
        try {
            pstmt = con.prepareStatement( "select address from sec_services" );
            rs = pstmt.executeQuery();
            while ( rs.next() ) {
