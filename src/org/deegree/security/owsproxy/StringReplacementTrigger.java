//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/owsproxy/StringReplacementTrigger.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class StringReplacementTrigger implements Trigger {
    ...
    private Object[] handleResponseValidation( Object[] values ) {
        ...
        if ( ( request instanceof WMSGetCapabilities && consideredRequests.indexOf( "WMS:GetCapabilities" ) > -1 )
             ...
             || ( request instanceof SOSGetCapabilities && consideredRequests.indexOf( "SOS:GetCapabilities" ) > -1 )
