...
/**
 * An OWSProxyPolicyFilter can be registered as a ServletFilter to a web context. It offeres a facade that looks like a
 ...
 * 
 * @version $Revision: 7461 $, $Date: 2007-06-05 15:35:14 +0200 (Di, 05 Jun 2007) $
 */
public class ConfigurableOWSProxyServletFilter implements Filter {
    ...
    public void doFilter( ServletRequest request, ServletResponse response, FilterChain chain )
        ...
        if ( !imageExpected ) {
            // fixup encoding mess: convert byte array into system charset for processing
        ...
        // fixup encoding mess: convert encoding of byte array into response charset for sending
        if ( !imageExpected ) {
    ...
    private User getUser( HttpServletRequest request, OGCWebServiceRequest owsReq )
        ...
        // no authentication method succeeded (usr is still null)
