//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/owsrequestvalidator/wms/GetFeatureInfoRequestValidator.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class GetFeatureInfoRequestValidator extends RequestValidator {
    ...
    /**
     * validates the incoming GetFeatureInfo request against the policy assigned to a
     * validator
     * 
