//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/security/owsrequestvalidator/GeneralPolicyValidator.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GeneralPolicyValidator {
    ...
    /**
     * validates if the passed length of a request content doesn't exceeds the defined maximum
     * length. If the OperationParameter indicates that the condition is coupled to specific user
     * rights, these rights will be read from the rights management system
     * 
     * @param contentLength
