//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/UUID.java $
/*----------------------------------------
 ...
 *
 * <p>
 * The values in the system catalog held in ID columns with a type of CHAR(36) are the string
 * representations of these UUIDs.
 *
 * <p>
...
public interface UUID extends java.io.Externalizable {
     ...
     * identifier.
     * @return the ansi identifier
     */
    String toANSIidentifier();

    /**
     * Produce a byte array representation of this UUID which can be passed to
     * UUIDFactory.recreateUUID later on to reconstruct it.
     * @return byte array representation of this uuid
     */
    byte[] toByteArray();
