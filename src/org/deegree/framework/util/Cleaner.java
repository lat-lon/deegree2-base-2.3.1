//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/Cleaner.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Cleaner extends TimerTask {
    ...
    /**
     * the run mehtod will called after the interval (milli seconds) passed to the constructor. An
