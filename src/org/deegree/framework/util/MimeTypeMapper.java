//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/MimeTypeMapper.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class MimeTypeMapper {
     ...
     * @param contentType
     * 
     * @return true if the contentType starts with "application/vnd.ogc"
     */
     ...
     * @param contentType
     * 
     * @return true if the contenttype starts with 'image'
     */
     ...
     * @param contentType
     * 
     * @return true if the content type denotes an image mime-type
     */
     ...
     * @param contentType
     * 
     * @return true if the mime type is known
     */
    ...
    /**
     * maps a 'simple' format name like gif, jpg or text to the corresponding mime type --> e.g.
     * image/gif, image/jpeg or text/plain
     * 
     * @param contentType
     * 
