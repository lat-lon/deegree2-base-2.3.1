//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/BasicUUID.java $
/*
...
public class BasicUUID implements UUID {
    ...
    /**
     * Constructor only called by BasicUUIDFactory. Constructs a UUID from the string representation
    ...
    /**
     * Constructor only called by BasicUUIDFactory. Constructs a UUID from the byte array
     * representation produced by toByteArrayio.
     * 
     * @param b
    ...
    /**
     * Read a long value, msb first, from its character representation in the string reader, using
     * '-' or end of string to delimit.
     */
     ...
     * 
     * @return a hashCode which is compatible with the equals() method.
     */
    public int hashCode() {
    ...
    /**
     * Produce a string representation of this UUID which can be passed to UUIDFactory.recreateUUID
     * later on to reconstruct it. The funny representation is designed to (sort of) match the
     * format of Microsoft's UUIDGEN utility.
     * 
    ...
    /**
     * Produce a string representation of this UUID which is suitable for use as a unique ANSI
     * identifier.
     * 
     * @return a string representation of this UUID
     */
    public String toANSIidentifier() {
        return stringWorkhorse( 'X' );
    }
    ...
    /**
     * Store this UUID in a byte array. Arrange the bytes in the UUID in the same order the code
     * which stores a UUID in a string does.
     * 
     * @return UUID in a byte array.
     * 
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.framework.util.UUID#toHexString()
     */
