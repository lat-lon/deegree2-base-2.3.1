//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/StringTools.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class StringTools {
    ...
    /**
     * Initialize the substitution map with all normalization rules for a given locale and add this
     * map to the static localeMap.
     * 
     * @param locale
     * @throws IOException
     * @throws SAXException
    ...
    private static void initMap( String locale )
        ...
        List list = XMLTools.getNodes( xml.getRootElement(), xpath, CommonNamespaces.getNamespaceContext() );
        if ( list != null ) {
            for ( int i = 0; i < list.size(); i++ ) {
                String src = XMLTools.getRequiredNodeAsString( (Node) list.get( i ), "Source",
                                                               CommonNamespaces.getNamespaceContext() );
                String target = XMLTools.getRequiredNodeAsString( (Node) list.get( i ), "Target",
                                                                  CommonNamespaces.getNamespaceContext() );
    ...
    /**
     * The passed string gets normalized along the rules for the given locale as they are set in the
     * file "./normalization.xml". If such rules are specified, the following order is obeyed:
     * 
     * <ol>
     * <li>if the attribute "case" is set with "toLower" or "toUpper", the letters are switched to
     * lower case or to upper case respectively.</li>
