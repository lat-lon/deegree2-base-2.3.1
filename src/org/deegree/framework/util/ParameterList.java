//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/util/ParameterList.java $
/*----------------    FILE HEADER  ------------------------------------------
...
final public class ParameterList {
    ...
    /**
     * returns the parameter that matches the submitted name. if no parameter can be found
    ...
    /**
     * returns all <tt>Parameter</tt>s contained within the list as array. it is guarenteered
    ...
    /**
     * returns an array of all <tt>Parameter</tt>s names. it is guarenteered that the arrays
     * isn't <tt>null</tt>
     * 
    ...
    /**
     * returns an array of all <tt>Parameter</tt>s values. it is guarenteered that the arrays
     * isn't <tt>null</tt>
     * 
