//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/jndi/JndiUtils.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public final class JndiUtils {
    ...
    /**
     * Lookup at Enterprise Java Beans environment value. For home interfaces use EJBRemoteFactory
     * instead
     * 
     * @param name
     ...
     *            the class to narrow
     * 
     * @return if an entry exists, an instance of the given class with a value retrieved from the
     *         JNDI tree otherwise <code>null</code>.
     * 
     * @throws NamingException
