//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/log/LoggerService.java $
/*----------------    FILE HEADER  ------------------------------------------
...
abstract class LoggerService implements ILogger {
    ...
    /**
     * Logs the given {@link XMLFragment} to a temporary file (created from specified prefix and
     * suffix ".xml") if log level is set to <code>LOG_DEBUG</code>.
     * 
     * @param filePrefix
     *            prefix for the temp file name
     * @param fragment
