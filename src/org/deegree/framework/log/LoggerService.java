//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/log/LoggerService.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @author last edited by: UID=$Author: rbezema $
 * 
 * @version $Revision: 14575 $, $Date: 2008-10-30 09:45:52 +0100 (Do, 30. Okt 2008) $
 * 
 * @see LoggerFactory
