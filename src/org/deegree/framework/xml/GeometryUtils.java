//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/xml/GeometryUtils.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GeometryUtils {
     ...
     * @return the centroid of the given geometry transformed to the targetCRS. or <code>null</code> if it could not
     *         be calculated.
     */
