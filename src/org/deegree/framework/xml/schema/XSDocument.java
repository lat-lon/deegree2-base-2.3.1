//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/framework/xml/schema/XSDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class XSDocument extends XMLFragment {
    ...
    public synchronized URI getTargetNamespace()
        ...
        if ( this.targetNamespace == null ) {
            this.targetNamespace = XMLTools.getRequiredNodeAsURI( this.getRootElement(), "@targetNamespace", nsContext );
        }
    ...
    public SimpleTypeDeclaration[] extractSimpleTypeDeclarations()
                            throws XMLParsingException {
        List simpleTypeElements = XMLTools.getNodes( this.getRootElement(), getFullName( "simpleType" ), nsContext );
    ...
    public ComplexTypeDeclaration[] extractComplexTypeDeclarations()
                            throws XMLParsingException {
        List complexTypeElements = XMLTools.getNodes( this.getRootElement(), getFullName( "complexType" ), nsContext );
    ...
    public ElementDeclaration[] extractElementDeclarations()
                            throws XMLParsingException {
        List complexTypeElements = XMLTools.getNodes( this.getRootElement(), getFullName( "element" ), nsContext );
     ...
     * 
     * @param name
     *            the name of the element declaration to look up (w/o namespace)
