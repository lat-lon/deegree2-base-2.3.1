//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/RemoteWFService.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class RemoteWFService implements OGCWebService {
    ...
    /**
     * performs a GetFeature request against the remote service. The method uses http-POST to call
     * the remote WFS
     * 
     * @param request
     *            get feature request
    ...
    /**
     * Pefroms a describe feature type request against a remote WFS. The method uses http-GET to
     * call the remote WFS
     * 
     * @param request
    ...
    /**
     * reads the capabilities from the remote WFS by performing a GetCapabilities request against
     * it. The method uses http-GET to call the remote WFS
     * 
     * @param request
