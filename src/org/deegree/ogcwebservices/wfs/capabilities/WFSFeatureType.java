// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/capabilities/WFSFeatureType.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WFSFeatureType {
    ...
    /**
     * Returns whether the feature type definition is virtual, i.e. all of it's output formats are
     * processed using an (input) XSLT-script.
     * 
