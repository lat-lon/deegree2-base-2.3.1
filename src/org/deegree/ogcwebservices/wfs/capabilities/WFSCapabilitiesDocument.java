// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/capabilities/WFSCapabilitiesDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WFSCapabilitiesDocument extends OWSCommonCapabilitiesDocument {
    ...
    public void createEmptyDocument(String version) {
        ...
        Element root = doc.createElementNS( "http://www.opengis.net/wfs", PRE_WFS + "WFS_Capabilities" );
     ...
     * document. <p> NOTE: this method is overridden, because the WFS 1.1.0 requires the OWS 1.0.0
...
//                                                                       element );
    ...
    public OperationsMetadata getOperationsMetadata() throws XMLParsingException {
        ...
        List<Node> operationElementList = XMLTools.getNodes( getRootElement(),
        ...
        for ( int i = 0; i < operationElementList.size(); i++ ) {
            operations.put( XMLTools.getRequiredNodeAsString(  operationElementList.get( i ),
                                                              "@name", nsContext ),
    ...
    public FormatType getFormatType( Element element ) throws XMLParsingException {
        ...
        URI[] uris = new URI[3];
        tmp[0] = XMLTools.getNodeAsString( element, "@deegreewfs:inFilter", nsContext,
                                                    null );
        tmp[1] = XMLTools.getNodeAsString( element, "@deegreewfs:outFilter", nsContext,
                                           null );
        tmp[2] = XMLTools.getNodeAsString( element, "@deegreewfs:schemaLocation",
                                           nsContext, null );
    ...
    public org.deegree.ogcwebservices.wfs.capabilities.Operation[] getOperationsType(
                                                                                     Element element ) throws XMLParsingException {
