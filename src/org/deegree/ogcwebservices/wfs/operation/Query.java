//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/operation/Query.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Query {
     ...
     * @deprecated use create(PropertyPath[], Function[], SortProperty[], String, String, QualifiedName[], String[],
    ...
    private void augmentFilterOperationWithNamespace( Operation operation, URI defaultNamespace ) {
        if ( operation instanceof ComparisonOperation ) {
            ...
            augmentPropertyPath( spatialOperation.getPropertyName().getValue(), defaultNamespace );
        }
