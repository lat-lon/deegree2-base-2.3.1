//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/operation/LockFeatureDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class LockFeatureDocument extends AbstractWFSRequestDocument {
    ...
    static long parseExpiry( Element root )
        ...
        long millis = 0;
        String expiry = XMLTools.getNodeAsString( root, "@expiry", nsContext,
                                                  LockFeature.DEFAULT_EXPIRY );
    ...
    private Lock parseLock( Element lockElement )
        ...
        QualifiedName typeName = XMLTools.getRequiredNodeAsQualifiedName( lockElement, "@typeName",
                                                                          nsContext );
        Filter filter = null;
