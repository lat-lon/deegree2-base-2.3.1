//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/operation/GetFeatureWithLock.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * This is identical to a {@link GetFeature} request, except that the features matching the request
 * will also be locked.
 * 
...
public class GetFeatureWithLock extends GetFeature {
    ...
    /**
     * Creates a new <code>GetFeatureWithLock</code> instance from a document that contains the
    ...
    /**
     * Creates a new <code>GetFeatureWithLock</code> instance from the given key-value pair
     * encoded request.
     * 
     * @param id
     *            request identifier
