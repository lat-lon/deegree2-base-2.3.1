...
public class Transaction extends AbstractWFSRequest {
    ...
    public static enum RELEASE_ACTION {
        ...
        /**
         * Indicates that the locks on all feature instances locked using the associated lockId
         * should be released when the transaction completes, regardless of whether or not a
         * particular feature instance in the locked set was actually operated upon.
         */
        ALL,
         ...
         * lockId so that subsequent transactions can operate on those feature instances. If an
         * expiry period was specified, the expiry counter must be reset to zero after each
         * transaction unless all feature instances in the locked set have been operated upon.
         */
        SOME
    }
