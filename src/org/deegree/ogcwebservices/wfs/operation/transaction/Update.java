//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/operation/transaction/Update.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * The <code>Update</code> element describes one update operation that is to be applied to a <code>Feature</code> or
 * a set of <code>Feature</code>s of a single <code>FeatureType</code>.
 * <p>
 * Multiple <code>Update</code> operations can be contained in a single <code>Transaction</code> request. An
 * <code>Update</code> element contains one or more <b>Property</b> elements that specify the name and replacement
 * value for a property that belongs to the <code>FeatureType</code> specified using the <b>mandatory typeName</b>
 * attribute.
 * <p>
...
public class Update extends TransactionOperation {
     ...
     * Creates a new <code>Update</code> instance.
     * <p>
     * NOTE: This constructor will be removed in the future, because it makes the DOM representation
     * available and breaks the layering (DOM should not be used on this level).
     * 
     * @param handle
     *            optional identifier for the operation (for error messsages)
     * @param typeName
    ...
    /**
     * Return the properties and their replacement values (as DOM representation).
     * 
     * NOTE: This constructor will be removed in the future, because it makes the DOM representation
     * available and breaks the layering (DOM should not be used on this level).
     * 
