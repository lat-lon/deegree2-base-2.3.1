//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/operation/AbstractWFSRequest.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12545 $, $Date: 2008-06-26 11:07:15 +0200 (Do, 26. Jun 2008) $
 */
public class AbstractWFSRequest extends AbstractOGCWebServiceRequest {
    ...
    protected static void checkServiceParameter( Map<String, String> model )
        ...
        if ( service == null || service.equals( "" ) ) {
            throw new MissingParameterValueException( "service", "'SERVICE' parameter must be set." );
        }
    ...
    protected static Filter extractBBOXFilter( Map<String, String> model )
        ...
        if ( bboxString != null ) {
            ...
            // build filter
            Envelope bbox = createEnvelope( coords[0], coords[1], coords[2], coords[3], srs );
            Surface surface;
            try {
