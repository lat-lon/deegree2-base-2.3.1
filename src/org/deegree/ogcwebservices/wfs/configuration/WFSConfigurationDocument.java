//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/configuration/WFSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
    ...
    public WFSDeegreeParams getDeegreeParams()
        ...
        try {
            ...
            deegreeParams = new WFSDeegreeParams( defaultOnlineResource, cacheSize, requestTimeLimit, characterSet,
                                                  dataDirectories, lockManagerDir, checkUTMZones );
