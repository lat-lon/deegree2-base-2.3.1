//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/configuration/WFSConfiguration.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WFSConfiguration extends WFSCapabilities {
     ...
     * <li>All {@link MappedFeatureType}s defined in any of the found {@link MappedGMLSchemaDocument}s are extracted,
     * if duplicate feature type definitions occur, an <code>InvalidConfigurationException</code> is thrown.</li>
    ...
    private void validateFeatureTypeDefinitions()
        ...
        Map tempFeatureTypeMap = (Map) ( (HashMap) this.ftMap ).clone();
    ...
    private WFSFeatureType createWFSFeatureType( MappedFeatureType mappedFeatureType )
        ...
        WFSFeatureType featureType = new WFSFeatureType( mappedFeatureType.getName(), null, null, null, defaultSRS,
                                                         null, operations, outputFormats, wgs84BoundingBoxes, null );
        return featureType;
    }
