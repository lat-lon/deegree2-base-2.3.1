//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/GetFeatureHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Handles {@link GetFeature} requests to the {@link WFService}. Since a {@link GetFeature} request
 * may contain more than one {@link Query}, each {@link Query} is delegated to an own thread.
 * <p>
 ...
 * 
 * @version $Revision: 11355 $, $Date: 2008-04-22 14:05:57 +0200 (Tue, 22 Apr 2008) $
 */
class GetFeatureHandler {
    ...
    /**
     * Creates a new instance of <code>GetFeatureHandler</code>. Only called by the associated
     * {@link WFService} (once).
     * 
     * @param wfs
    ...
    FeatureResult handleRequest( GetFeature getFeature )
        ...
        for ( Query query : queries ) {
            ...
            // check and normalize requested SRS
