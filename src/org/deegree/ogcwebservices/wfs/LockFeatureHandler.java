//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/LockFeatureHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class LockFeatureHandler {
    ...
    /**
     * Creates a new instance of <code>LockFeatureHandler</code>. Only called by the associated
     * {@link WFService} (once).
     * 
     * @param wfs
     ...
     * <li>Create a corresponding {@link LockFeature} request from the {@link GetFeatureWithLock}
     * request.</li>
    ...
    /**
     * Groups all {@link Lock}s contained in the given {@link LockFeature} request by the
     * responsible {@link Datastore}, i.e. that serves the {@link FeatureType} to be locked.
     * 
     * @param request
