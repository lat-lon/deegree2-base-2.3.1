 ...
 * 
 * @version $Revision: 13631 $, $Date: 2008-08-15 11:29:36 +0200 (Fr, 15. Aug 2008) $
 */
class TransactionHandler {
                ...
                if ( operation instanceof Insert ) {
                    ...
                    if ( request.getVersion().equals( "1.0.0" ) ) {
                        ...
                        try {
                            ...
                            throw new MissingParameterValueException( "LockId" );
                        }
                    }
                } else if ( operation instanceof Update ) {
    ...
    private List<FeatureId> performInsert( Insert insert )
        ...
        // clear reference to merger (and implicitly feature collection)
        merger = null;
