//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wfs/FeatureDisambiguator.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * inserted into a {@link org.deegree.io.datastore Datastore}). This is necessary, because it is up
...
class FeatureDisambiguator {
     ...
     * collection, the root feature is used as the representing feature instance. This is important
     * to guarantee that the root features in the collection represent themselves and need not to be
     * replaced in {@link #replaceDuplicateFeatures()}.
     * 
     * @throws DatastoreException
     */
     ...
     * <p>
     * Xlinked content is used for every subfeature that has been encountered already (or is a root
     * feature of the collection).
     * <p>
     * Root features are never replaced, because {@link #assignFIDsAndRepresenters()} ensures that
     * root features always represent themselves.
     */
     ...
     * <p>
     * Xlinked content is used for every subfeature that has been encountered already (or that is a
     * root feature of the collection).
     * 
     * @param feature
     * @param xlinkFIDs
     */
