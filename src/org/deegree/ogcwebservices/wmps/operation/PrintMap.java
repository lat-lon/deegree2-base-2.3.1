//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wmps/operation/PrintMap.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * enconding and the second is a HTTP POST request containing a SLD. It is possible to access the
 * values of a HTTP GET request throught its bean accessor methods. The request shall be mapped to a
 * SLD data structure, accessible using the <code>getSLD()</code> method.
 * 
...
public class PrintMap extends WMPSRequestBase implements Serializable {
    ...
    PrintMap( String id, String version, Layer[] layers, String srs, Envelope boundingBox, Point center,
              ...
              TextArea[] textAreas, Map<String, String> vendorSpecificParameter ) {
    ...
    public static PrintMap create( Element root )
        ...
        List list = XMLTools.getNodes( root, "deegreewmps:TextAreas/deegreewmps:TextArea", nsContext );
        ...
        return new PrintMap( id, version, layers, srsName, boundingBox, center, scaleDenominator, transparent, bgColor,
                             title, copyright, legend, scaleBar, note, template, emailAdd, setCurrentTime(), textAreas,
    ...
    public static PrintMap create( Map<String, String> model )
        ...
        return new PrintMap( id, version, layers, srs, boundingBox, center, scaleDenominator, transparent, bgColor,
                             title, copyRightNote, legend, scaleBar, note, template, emailaddress, setCurrentTime(),
                             textAreas, vendorSpecificParameter );
