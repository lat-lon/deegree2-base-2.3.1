//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wmps/configuration/WMPSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version 2.0, $Revision: 12808 $, $Date: 2008-07-10 13:48:56 +0200 (Do, 10. Jul 2008) $
 */
public class WMPSConfigurationDocument extends WMPSCapabilitiesDocument {
    ...
    public WMPSDeegreeParams parseDeegreeParams( Node root )
        ...
        WMPSDeegreeParams deegreeParams = new WMPSDeegreeParams( cache, maxLifeTime, reqTimeLimit, (float) mapQuality,
                                                                 ...
                                                                 featureInfoRadius, copyright, gazetteer, null,
                                                                 dtdLocation, proxy, synchList, cacheDatabase,
                                                                 printMapParam );
    ...
    private CacheDatabase parseCacheDatabase( Node root )
        ...
        if ( cacheDb != null ) {
            ...
            String driver = XMLTools.getRequiredNodeAsString( jdbcConnection, "./deegreewmps:Driver", nsContext );
            String url = XMLTools.getRequiredNodeAsString( jdbcConnection, "./deegreewmps:Url", nsContext );
            String user = XMLTools.getRequiredNodeAsString( jdbcConnection, "./deegreewmps:User", nsContext );
            String password = XMLTools.getRequiredNodeAsString( jdbcConnection, "./deegreewmps:Password", nsContext );
    ...
    private PrintMapParam parsePrintMapParam( Node root )
        ...
        PrintMapParam printMapParam = new PrintMapParam( format, templateDirectory, onlineResource, plotDirectory,
                                                         plotImgDir, adminMail, mailHost, mailTextTemplate, targetRes );
    ...
    protected Style[] parseStyles( Element layerElem )
        ...
        for ( int i = 0; i < styles.length; i++ ) {
            ...
            String styleAbstract = XMLTools.getNodeAsString( (Node) nl.get( i ), "./Abstract", nsContext, null );
            ...
            String styleResource = XMLTools.getNodeAsString( (Node) nl.get( i ), xPath, nsContext, "styles.xml" );
            URL sr = null;
            try {
