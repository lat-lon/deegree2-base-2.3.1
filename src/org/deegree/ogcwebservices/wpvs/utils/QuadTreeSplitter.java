//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/utils/QuadTreeSplitter.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class QuadTreeSplitter {
    ...
    private class QuadNode implements Comparable<QuadNode> {
         ...
         * @param sonID which son
         * @param son the reference
         */
