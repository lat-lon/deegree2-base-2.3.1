//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/capabilities/WPVSCapabilitiesDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * $Revision: 10557 $, $Date: 2008-03-11 17:33:10 +0100 (Tue, 11 Mar 2008) $
 * 
 */
public class WPVSCapabilitiesDocument extends OWSCommonCapabilitiesDocument {
    ...
    protected Envelope parseBoundingBox( Element element, CoordinateSystem defaultCoordinateSystem )
        ...
        System.out.println( "------------------------------crsAtt: " + crsAtt );
