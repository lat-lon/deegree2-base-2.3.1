//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/configuration/WPVSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10557 $, $Date: 2008-03-11 17:33:10 +0100 (Tue, 11 Mar 2008) $
 */
public class WPVSConfigurationDocument extends WPVSCapabilitiesDocument {
    ...
    public WPVSConfiguration parseConfiguration()
        ...
        try {
            ...
            Element requestedNode = (Element) XMLTools.getRequiredNode( getRootElement(),
                                                                        PRE_DWPVS + "deegreeParams",
                                                                        nsContext );
            ...
            Dataset rootDataset = parseDataset( requestedNode,
                                                null,
                                                null,
                                                0,
                                                9E9,
            ...
            wpvsConfiguration = new WPVSConfiguration( parseVersion(),
                                                       parseUpdateSequence(),
    ...
    private WPVSDeegreeParams parseDeegreeParams( Node deegreeNode )
        ...
        Element deegreeElement = (Element) XMLTools.getRequiredNode( deegreeNode,
                                                                     PRE_DWPVS + "DefaultOnlineResource",
                                                                     nsContext );
        ...
        int maxTextureDimension = XMLTools.getNodeAsInt( deegreeNode,
                                                         PRE_DWPVS + "MaxTextureDimension",
                                                         nsContext,
                                                         Integer.MAX_VALUE );
        
        int quadMergeCount = XMLTools.getNodeAsInt( deegreeNode,
                                                         PRE_DWPVS + "QuadMergeCount",
                                                         nsContext, 10 );
        ...
        if ( copyrightNode != null ) {
            ...
            if ( copyTextNode != null ) {
                ...
                copyright = XMLTools.getRequiredNodeAsString( copyrightNode,
                                                              PRE_DWPVS + "ImageURL/@xlink:href",
                                                              nsContext );

                isWatermarked = XMLTools.getNodeAsBoolean( copyrightNode,
                                                           PRE_DWPVS + "ImageURL/@watermark",
                                                           nsContext,
                                                           isWatermarked );
        ...
        boolean quality = XMLTools.getNodeAsBoolean( deegreeNode,
                                                     PRE_DWPVS + "RequestQualityPreferred",
                                                     nsContext,
                                                     true );
        double maximumFarClippingPlane = XMLTools.getNodeAsDouble( deegreeNode,
                                                                   PRE_DWPVS + "RequestsMaximumFarClippingPlane",
                                                                   nsContext,
                                                                   15000 );
        ...
        double minimalTerrainHeight = XMLTools.getNodeAsDouble( deegreeNode,
                                                                PRE_DWPVS + "MinimalTerrainHeight",
                                                                nsContext,
                                                                0 );
        ...
        double extendRequestPercentage = XMLTools.getNodeAsDouble( deegreeNode,
                                                                   PRE_DWPVS + "ExtendRequestPercentage",
                                                                   nsContext,
                                                                   0 );
        if ( extendRequestPercentage > 100 ) {
            LOG.logWarning( Messages.getMessage( "WPVS_WRONG_EXTEND_REQUEST_PERCENTAGE",
                                                 Double.valueOf( extendRequestPercentage ),
                                                 Double.valueOf( 100 ) ) );
        ...
        WPVSDeegreeParams wpvsDeegreeParams = new WPVSDeegreeParams( defaultOnlineResource,
                                                                     cacheSize,
                                                                     reqTimeLimit,
                                                                     charSet,
                                                                     copyright,
                                                                     ...
                                                                     maxTextureDimension, quadMergeCount );
    ...
    private Dataset parseDataset( Element datasetElement, Dataset parent, CoordinateSystem defaultCoordinateSystem,
        ...
        double minScaleDenom = XMLTools.getNodeAsDouble( datasetElement,
                                                         PRE_DWPVS + "MinimumScaleDenominator/text()",
                                                         nsContext,
                                                         defaultMinScaleDonominator );
        ...
        double maxScaleDenom = XMLTools.getNodeAsDouble( datasetElement,
                                                         PRE_DWPVS + "MaximumScaleDenominator/text()",
                                                         nsContext,
        ...
        ElevationModel elevationModel = parseElevationModel( datasetElement,
                                                             ...
                                                             defaultMinScaleDonominator,
                                                             defaultMaxScaleDenominator );
        AbstractDataSource[] dataSources = parseAbstractDatasources( datasetElement,
                                                                     name,
                                                                     defaultMinScaleDonominator,
                                                                     defaultMaxScaleDenominator,
                                                                     currentCRS );
        ...
        for ( int i = 0; i < childDatasets.length; i++ ) {
            childDatasets[i] = parseDataset( nl.get( i ),
                                             dataset,
    ...
    /**
     * Creates and returns a new <code>ElevationModel</code> object from the given <code>Element</code> and the
     * parent <code>Dataset</code>.
     * 
    ...
    private ElevationModel parseElevationModel( Element datasetElement, String parentName,
        ...
        if ( elevationElement != null ) {
            ...
            dataSources = parseAbstractDatasources( elevationElement,
                                                    parentName,
                                                    defaultMinScaleDenominator,
                                                    defaultMaxScaleDenominator,
                                                    defaultCRS );
            ...
            if ( !Double.isNaN( minimalWCS_DGMResolution ) ) {
                ...
                for ( AbstractDataSource source : dataSources ) {
                    if ( source.getServiceType() == AbstractDataSource.LOCAL_WCS || source.getServiceType() == AbstractDataSource.REMOTE_WCS ) {
    ...
    private AbstractDataSource[] parseAbstractDatasources( Element element, String parentName,
        ...
        for (  Element dataSourceElement : abstractDataSources ){
            ...
            if ( nodeName != null && nodeName.endsWith( "DataSource" ) ) {
                ...
                double minScaleDenom = XMLTools.getNodeAsDouble( dataSourceElement,
                                                                 PRE_DWPVS + "MinimumScaleDenominator/text()",
                                                                 nsContext,
                                                                 defaultMinScaleDenominator );
                ...
                double maxScaleDenom = XMLTools.getNodeAsDouble( dataSourceElement,
                                                                 PRE_DWPVS + "MaximumScaleDenominator/text()",
                                                                 nsContext,
                                                                 defaultMaxScaleDenominator );
                ...
                if ( nodeName.equals( "LocalWCSDataSource" ) || "RemoteWCSDataSource".equals( nodeName ) ) {
                    Element filterElement = (Element) XMLTools.getRequiredNode( dataSourceElement,
                                                                                PRE_DWPVS + "FilterCondition",
                                                                                nsContext );
                    ...
                    if ( "RemoteWCSDataSource".equals( nodeName ) ) {
                        dataSource = new RemoteWCSDataSource( name,
                                                              owsCapabilities,
                                                              validArea,
                                                              minScaleDenom,
                                                              maxScaleDenom,
                        ...
                        dataSource = new LocalWCSDataSource( name,
                                                             owsCapabilities,
                                                             validArea,
                                                             minScaleDenom,
                                                             maxScaleDenom,
                    ...
                    Text geoPropNode = (Text) XMLTools.getRequiredNode( dataSourceElement,
                                                                        PRE_DWPVS + "GeometryProperty/text()",
                                                                        nsContext );
                    ...
                    int maxFeatures = XMLTools.getNodeAsInt( dataSourceElement, PRE_DWPVS + "MaxFeatures", nsContext, -1 );
                    ...
                    dataSource = new LocalWFSDataSource( name,
                                                         owsCapabilities,
                                                         validArea,
                                                         minScaleDenom,
                                                         maxScaleDenom,
                    ...
                    dataSource = new RemoteWFSDataSource( name,
                                                          owsCapabilities,
                                                          validArea,
                                                          minScaleDenom,
                                                          maxScaleDenom,
                                                          geometryProperty,
                                                          filterCondition, maxFeatures );
                    ...
                    dataSource = new LocalWMSDataSource( name,
                                                         owsCapabilities,
                                                         validArea,
                                                         minScaleDenom,
                                                         maxScaleDenom,
                    ...
                    dataSource = new RemoteWMSDataSource( name,
                                                          owsCapabilities,
                                                          validArea,
                                                          minScaleDenom,
                                                          maxScaleDenom,
    ...
    private OWSCapabilities parseOWSCapabilities( Element element )
        ...
        Element owsCapabilitiesElement = (Element) XMLTools.getRequiredNode( element,
                                                                             PRE_DWPVS + "OWSCapabilities",
                                                                             nsContext );
    ...
    private Surface parseValidArea( Element dataSource, CoordinateSystem defaultCRS )
        ...
        if ( nl.size() > 1 ) {
            LOG.logWarning( Messages.getMessage( "WPVS_WRONG_NUMBER_OF_VALID_AREAS",
                                                 GMLNS.toASCIIString(),
        ...
        } else if ( firsElement.getNamespaceURI().equals( CommonNamespaces.OWSNS ) ) {
            try {
    ...
    private Color[] parseTransparentColors( Element dataSourceElement )
        ...
        List<Element> colorList = XMLTools.getElements( dataSourceElement,
                                            PRE_DWPVS + "TransparentColors/" + PRE_DWPVS + "Color",
                                            nsContext );
