//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/j3d/ColoredSurface.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ColoredSurface extends DefaultSurface {
     ...
     * @param transparency
     */
    public ColoredSurface( String objectID, String parentId, Surface surface, float red,
                          float green, float blue, float transparency ) {
     ...
     * @param transparency
     */
    public ColoredSurface( String objectID, String parentId, Surface surface, Material material,
                          float transparency ) {
        super( objectID, parentId, surface );
        setAppearance( createAppearance( material, transparency ) );
    }
