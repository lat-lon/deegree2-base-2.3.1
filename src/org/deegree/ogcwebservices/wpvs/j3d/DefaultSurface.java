//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/j3d/DefaultSurface.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DefaultSurface extends Shape3D {
    ...
    public DefaultSurface( String objectID, String parentID, Surface surface ) {
        ...
        /*
         * System.out.println( "new Appearance" ); Color3f specular = new Color3f( 0.7f, 0.7f, 0.7f );
         ...
         * targetMaterial.setShininess( 75.0f ); targetMaterial.setLightingEnable( true );
         * targetMaterial.setCapability( Material.ALLOW_COMPONENT_WRITE ); // ColoringAttributes ca =
         * new ColoringAttributes(); ca.setShadeModel( ColoringAttributes.SHADE_GOURAUD ); //
         * Appearance defaultAppearance = new Appearance(); defaultAppearance.setMaterial(
         * targetMaterial ); defaultAppearance.setColoringAttributes( ca ); // PolygonAttributes
         * targetPolyAttr = new PolygonAttributes(); targetPolyAttr.setCapability(
         * PolygonAttributes.ALLOW_MODE_WRITE ); targetPolyAttr.setCapability(
         * PolygonAttributes.ALLOW_NORMAL_FLIP_WRITE ); targetPolyAttr.setPolygonMode(
         * PolygonAttributes.POLYGON_FILL ); targetPolyAttr.setCullFace( PolygonAttributes.CULL_NONE ); //
         * pa.setPolygonMode( PolygonAttributes.POLYGON_LINE );
         * defaultAppearance.setPolygonAttributes( targetPolyAttr ); setAppearance(
         * defaultAppearance );
         */
    }
