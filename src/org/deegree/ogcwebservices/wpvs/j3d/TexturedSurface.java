//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/j3d/TexturedSurface.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10478 $, $Date: 2008-03-06 12:44:45 +0100 (Thu, 06 Mar 2008) $
 * 
 */
public class TexturedSurface extends ColoredSurface {
     ...
     * @param textureCoords
     */
    public TexturedSurface( String objectID, String parentID, Surface surface, Material material, float transparency,
        ...
        addGeometry( surface, textureCoords );
    }
    ...
    public void addGeometry( Surface surface, List<TexCoord2f> texCoords ) {
        ...
        LOG.logDebug( "Geometry has number of vertices: " + coordinates.size()
                      + " the number of Strip counts adds up to: "
                      + stripCountNumber );
