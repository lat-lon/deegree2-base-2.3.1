//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wpvs/j3d/Object3DFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * $Revision: 12271 $, $Date: 2008-06-10 15:00:47 +0200 (Di, 10. Jun 2008) $
 * 
 */
public class Object3DFactory {
    ...
    public DefaultSurface createSurface( Feature feature, Map<String, TexturedSurface> texturedShapes ) {
        ...
        resultSurface = createSurface( texturedShapes, cachedSurface, geometry, textImage, textureFile, material,
