...
public class DefaultGet3DFeatureInfoHandler extends Get3DFeatureInfoHandler {
    ...
    public Get3DFeatureInfoResponse handleRequest( Get3DFeatureInfo request )
        ...
        for ( String s : qDatasets ) {
            ...
            if ( dataset == null ) {
                throw new LayerNotDefinedException( Messages.getMessage( "WPVS_UNDEFINED_DATASET", dataset.getName() ) );
            }
            // test if queryable
    ...
    /**
     * Tests the parameter feat for an intersection with the Ray of view and calculates the distance
     * between ViewPoint and feature.
     * 
     * @param feat
    ...
    /**
     * Handles the WFS GetFeature-Request for all datasets. Collects the Responses in the
     * FeatureCollection of all valide Results.
     * 
     * @param datasets
