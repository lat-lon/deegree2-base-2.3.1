//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/configuration/RemoteWMSDataSource.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class RemoteWMSDataSource extends AbstractDataSource {
     ...
     * @param reqTimeLimit 
     * @param passedParameters parameter names to be passed in incoming GetMap requests
     * @param addedParameters parameters and values to be added to outgoing GetMap requests
     */
    public RemoteWMSDataSource( boolean querable, boolean failOnException, QualifiedName name, 
                               ...
                               URL featureInfoTransform, int reqTimeLimit, List<String> passedParameters, Map<String, String> addedParameters ) {
