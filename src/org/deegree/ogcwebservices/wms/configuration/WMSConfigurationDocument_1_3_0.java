//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/configuration/WMSConfigurationDocument_1_3_0.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * <code>WMSConfigurationDocument_1_3_0</code> is the parser class for a WMS 1.3.0 configuration
 * document.
 * 
 * @author <a href="mailto:schmitz@lat-lon.de">Andreas Schmitz</a>
 * @author last edited by: $Author: apoth $
 * 
 * @version 2.0, $Revision: 11357 $, $Date: 2008-04-22 14:07:12 +0200 (Tue, 22 Apr 2008) $
 * 
 * @since 2.0
 */
...
public class WMSConfigurationDocument_1_3_0 extends WMSCapabilitiesDocument_1_3_0 {
    ...
    protected AbstractDataSource[] parseDataSources( Element layerElem, String layerName, ScaleHint scaleHint )
        ...
        for ( int i = 0; i < ds.length; i++ ) {
            ...
            scaleHint = parseDSScaleHint( nl.get( i ), scaleHint );

            String s = "./deegreewms:OWSCapabilities/deegreewms:OnlineResource";
            Element node = XMLTools.getRequiredElement( nl.get( i ), s, nsContext );
            ...
            try {
                if ( "LOCALWFS".equals( stype ) ) {
                    ...
                    parseWCSFilterCondition( nl.get( i ) );
                    // Color[] colors =
                    parseTransparentColors( nl.get( i ) );
                    // TODO
