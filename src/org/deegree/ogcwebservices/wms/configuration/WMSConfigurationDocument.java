//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/configuration/WMSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version 2.0, $Revision: 14885 $, $Date: 2008-11-18 13:25:10 +0100 (Di, 18. Nov 2008) $
 * 
 * @since 2.0
 */
public class WMSConfigurationDocument extends WMSCapabilitiesDocument {
    ...
    public WMSDeegreeParams parseDeegreeParams( Node root )
        ...
        WMSDeegreeParams deegreeParams = new WMSDeegreeParams( cache, maxLifeTime, reqTimeLimit, (float) mapQuality,
                                                               ...
                                                               featureSchemaNamespace, filtersAllowed );
     ...
     * @param layerElem
     * @param scaleHint
     * @return the scale hint for the datasource
     * @throws XMLParsingException
     */
     ...
     */
    private DatabaseDataSource createDatabaseSource( Node node, boolean failOnEx, boolean queryable,
        ...
        return new DatabaseDataSource( queryable, failOnEx, name, scaleHint, validArea, reqTimeLimit, jdbc,
                                       sqlTemplate, geometryField, nativeCRS, customSQL );
    }
