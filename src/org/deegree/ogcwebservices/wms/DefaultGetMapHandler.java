//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/DefaultGetMapHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DefaultGetMapHandler implements GetMapHandler {
    ...
    private static final Pattern CHECKSQL = compile( "(^insert|^update|^delete|.*select.*[(].*[)].*from|.*[ ()]insert[() ]|.*[() ]update[() ]|.*[() ]delete[() ]).*" );
    ...
    /**
     * performs a GetMap request and retruns the result encapsulated within a <tt>GetMapResult</tt> object.
     * <p>
