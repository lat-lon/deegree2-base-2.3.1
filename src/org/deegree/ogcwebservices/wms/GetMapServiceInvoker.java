//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/GetMapServiceInvoker.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public abstract class GetMapServiceInvoker {
    ...
    /**
     * accesses the GML schema assigned to the feature type contained within the passed
     * FeatureTypeConstraint from a remote WFS by performing a DescribeFeatureType request
     * 
     * @param layer
     * @param ftc
    ...
    /**
     * accesses the GML schema assigned to the feature type contained within the passed
     * FeatureTypeConstraint from a local WFS by performing a DescribeFeatureType request
     * 
     * @param ftc
     * @return the schema document
     * @throws IOException
