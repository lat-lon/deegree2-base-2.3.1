//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/GraphicContextFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GraphicContextFactory {
     ...
     * to render the to. A <tt>BufferedImage</tt> for raster image mime types and a DOM
     * <tt>Document</tt> for SVG.
     * 
     * @param mimeType
