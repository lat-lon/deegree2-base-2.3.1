//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/DefaultGetFeatureInfoHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version 1.0. $Revision: 9697 $, $Date: 2008-01-23 12:19:46 +0100 (Wed, 23 Jan 2008) $
 * 
 */
            ...
            if ( datasource != null ) {
                ...
                try {
                    ...
                    case AbstractDataSource.REMOTEWCS: {
                        request = GetMapServiceInvokerForNL.createGetCoverageRequest( datasource, getMapRequest );
                        break;
                    }
