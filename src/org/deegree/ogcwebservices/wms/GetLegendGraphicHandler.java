// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/GetLegendGraphicHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * performs a GetLegendGraphic request. The capability of the deegree implementation is limited to
 * handle requests containing a named style or using the (named) styles defined in a passed or
 * referenced SLD. featuretype and rule are not supported yet.
 * 
...
class GetLegendGraphicHandler {
    ...
    /**
     * validates if the passed request is valid against the WMS it was sent to and the SLD maybe
     * contained or referenced in/by the request.
     * 
     * @param request
     *            request to validate
     */
    ...
    /**
     * creates a LegendElement from a style defined in the SLD document passed/referenced by/in the
     * request
     */
