//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/operation/GetFeatureInfo.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GetFeatureInfo extends WMSRequestBase {
    ...
    public static GetFeatureInfo create( String version, String id, String[] queryLayers,
        ...
        return new GetFeatureInfo( version, id, queryLayers, getMapRequestCopy,
