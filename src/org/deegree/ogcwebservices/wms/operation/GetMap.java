//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wms/operation/GetMap.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10467 $, $Date:20.03.2007$
 */
public class GetMap extends WMSRequestBase {
    ...
    public static GetMap create( Map<String, String> model )
        ...
        return new GetMap( version, id, ls, elevation, sampleDimension, format, width, height, srs, boundingBox,
                           transparency, bgColor, exceptions, time, sLD_URL, sld, vendorSpecificParameter );
    }
    ...
    /**
     * @return the URL of Styled Layer Descriptor (as defined in SLD Specification). This parameter
     *         is optional. If no sld URL is defined <tt>null</tt> will be returned.
     */
    ...
    /**
     * @return the URL of Web Feature CapabilitiesService providing features to be symbolized using
     *         SLD. This parameter is optional. If no WFS URL is defined <tt>null</tt> will be
     *         returned.
     */
     ...
     *         <p>
     *         </p>
     *         This mean even if a GetMap request is send using the HTTP GET method, an implementing
     *         class has to map the request to a SLD data structure.
     */
