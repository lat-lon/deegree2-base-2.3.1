...
public class OGCRequestFactory {
    ...
    public static OGCWebServiceRequest create( ServletRequest request )
        ...
        try {
            ...
            LOG.logDebug( "Error parsing XML request: " + e.getMessage(), e );
    ...
    public static OGCWebServiceRequest createFromKVP( Map<String, String> map )
        ...
        if ( WMS_SERVICE_NAME.equals( service ) ) {
            ...
            throw new OGCWebServiceException( "OGCRequestFactory", "Specified service '" + map.get( "SERVICE" )
                                                                   + "' is not a known OGC service type." );
        }
        return ogcRequest;
    }
     ...
     * @param doc
     *            to check
     * @return true if the namespace of the given dom-xml document equals
     *         {@link CommonNamespaces#WCTSNS}.
     */
     ...
     * @throws OGCWebServiceException
     *             if the requested operation is not one of the above mentioned, or something went
    ...
    /**
     * Creates an <code>AbstractOGCWebServiceRequest</code> from the passed <code>Docuement</code>.
     * the returned request will be a WCS request. The type of request is determind by the the also
     * passed 'request' parameter. Possible requests are:
     * <ul>
     * <li>GetCapabilities
     ...
     * @return one of the above mentioned Requests.
     * @throws OGCWebServiceException
     *             if the requested operation is not one of the above mentioned, not supported or
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>XML-Document</code>.
     * the returned request will be a WPVS request. The type of request is determind by the the also
     * passed 'request' parameter. Possible requests are:
     * <ul>
     * <li>GetCapabilities
     * <li>GetView
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>KVP-Map</code>. the
