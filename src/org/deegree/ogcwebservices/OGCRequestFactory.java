 ...
 * 
 * @version $Revision: 12900 $, $Date: 2008-07-14 17:14:30 +0200 (Mo, 14. Jul 2008) $
 */
public class OGCRequestFactory {
    ...
    public static OGCWebServiceRequest create( ServletRequest request )
        ...
        try {
            ...
            if ( request.getContentType() != null ) {
                ...
                // this was a nice try, but unfortunately #getReader is not the same as #getInputStream

                // additionally, use UTF-8/"system" charset when it's not specified in the request
                // if ( request.getCharacterEncoding() == null ) {
                // xmlReader = new InputStreamReader( request.getInputStream(), getSystemCharset() );
                // } else {
                // xmlReader = new InputStreamReader( request.getInputStream(), request.getCharacterEncoding() );
                // }
            } else {
                // DO NOT REMOVE THIS !!!!!
    ...
    /**
     * Creates an instance of an <code>AbstractOGCWebServiceRequest</code> from the passed DOM object. Supported OWS
     * are 'WMS', 'WFS', 'WCS' and 'CSW'. If a request for another service is passed or a request that isn't supported
     * by one of the listed services an exception will be thrown. <BR>
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>Document</code>. The returned request
     * will be a WFS request. The type of request is determined by also submitted request name. Known requests are:
     * <ul>
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>key value pair</code>. The returned
     * request will be a WSS request. The type of request is determined by also submitted request name. Known requests
     * are:
     * <ul>
     * <li>GetCapabilities</li>
     * <li>GetSession</li>
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>key value pair</code>. The returned
     * request will be a WAS request. The type of request is determined by also submitted request name. Known requests
     * are:
     * <ul>
     * <li>GetCapabilities</li>
     * <li>GetSession</li>
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>Object</code>. the returned request will
     * be a WCS request. The type of request is determind by the the also passed 'request' parameter. Possible requests
     * are:
     * <ul>
     * <li>GetCapabilities
     * <li>GetCoverage
    ...
    /**
     * Creates an <code>AbstractOGCWebServiceRequest</code> from the passed <code>Object</code>. the returned
     * request will be a WCS request. The type of request is determind by the the also passed 'request' parameter.
    ...
    /**
     * Creates an <code>AbstractOGCWebServiceRequest</code> from the passed <code>Docuement</code>. the returned
     * request will be a WCS request. The type of request is determind by the the also passed 'request' parameter.
     * Possible requests are:
     * <ul>
     * <li>GetCapabilities
    ...
    /**
     * Creates an <code>AbstractOGCWebServiceRequest</code> from the passed <code>Object</code>. The returned
     * request will be a <code>CSW</code> request. The type of request is determined by the the also passed 'request'
     * parameter. Allowed values for the request parameter are:
     * <ul>
     * <li>GetCapabilities</li>
     * <li>GetRecords</li>
    ...
    private static AbstractOGCWebServiceRequest getSOSRequest( String request, Object req )
        ...
        LOG.logDebug( "Creating SOS request '" + request + "' with ID=" + id + "/type:" + req.getClass().getName() );
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>XML-Document</code>. the returned request
     * will be a WPVS request. The type of request is determind by the the also passed 'request' parameter. Possible
     * requests are:
     * <ul>
     * <li>GetCapabilities
     * <li>GetView
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>KVP-Map</code>. the returned request will
    ...
    /**
     * Creates an <code>AbstractOGCWebServiceRequest</code> from the passed <code>Object</code>. the returned
     * request will be a WMPS request. The type of request is determind by the the also passed 'request' parameter.
     * Possible requests are:
     * <ul>
     * <li>GetCapabilities
     * </ul>
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>Map</code>. The returned request will be
    ...
    /**
     * Creates an <code>OGCWebServiceRequest</code> from the passed <code>Document</code>. The returned request
     * will be a WPS request. The type of request is determined by also submitted request name. Known requests are:
     * <ul>
     * <li>GetCapabilities</li>
     * <li>DescribeProcess</li>
     * <li>Execute</li>
