// $HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/getcapabilities/ServiceIdentification.java $
/*----------------    FILE HEADER  ------------------------------------------
