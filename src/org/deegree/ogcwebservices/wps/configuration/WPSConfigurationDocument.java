//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wps/configuration/WPSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WPSConfigurationDocument extends WPSCapabilitiesDocument {
     ...
     * 
     */
    private static final long serialVersionUID = -7291272633325453801L;

    private static final ILogger LOG = LoggerFactory.getLogger( WPSConfigurationDocument.class );
