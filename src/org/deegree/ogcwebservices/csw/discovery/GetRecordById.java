//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/csw/discovery/GetRecordById.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GetRecordById extends AbstractCSWRequest {
    ...
    /**
     * creates a <code>GetRecordById</code> request from the XML fragment passed. The passed
    ...
    /**
     * Creates a new <code>GetRecordById</code> instance from the values stored in the submitted
     ...
     * @return a GetRecordById bean representation, the internal request id will be set to
    ...
    public static GetRecordById create( Map<String, String> kvp ) {
        ...
        return new GetRecordById( Long.toString( IDGenerator.getInstance().generateUniqueID() ), 
                                  version, kvp, ids,
                                  elementSetName );
    }
    ...
    public static GetRecordById create( String id, Map<String, String> kvp ) {
        ...
        return new GetRecordById( id, version, kvp, ids, elementSetName );
    }
     ...
     *            requested element set (brief|summary|full). Can be <code>null</code>; will be
     *            treaded as full.
     */
    ...
    /**
     * @return the requested element set name. If the returned value equals <code>null</code> a
