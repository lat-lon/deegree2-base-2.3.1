//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/csw/discovery/XMLFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 9499 $, $Date: 2008-01-09 16:47:04 +0100 (Mi, 09. Jan 2008) $
 */
public class XMLFactory extends org.deegree.ogcbase.XMLFactory {
     ...
     * @param aliases
     *            may be <code>null</code>, if not each typeName must have exactly one alias
     *            defined, which will be inserted after the typename (e.g. typename=$o). If map must
     *            contain a mapping from variable to qualifiedName (e.g. [o, typeName]);
     */
