...
public class Mapping {
    ...
    /**
     * maps a property name of GetRecords, Delete and Update request from the catalogue 
     * schema to the underlying WFS schema
     * 
     * @param node
     * @return
     * @throws XMLParsingException
     */
    public static String mapPropertyValue( Node node, String hlevel ) throws XMLParsingException {
    ...
    /**
     * maps property names for sorting from the catalogue 
     * schema to the underlying WFS schema
     * @param node
     * @return
     * @throws XMLParsingException 
     */
    public static String mapSortProperty(Node node, String hlevel) throws XMLParsingException {
        String s = XMLTools.getNodeAsString( node, ".", nsc, null );
