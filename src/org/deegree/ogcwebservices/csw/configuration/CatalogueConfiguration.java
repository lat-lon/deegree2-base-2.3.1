...
public class CatalogueConfiguration extends CatalogueCapabilities {
    ...
    CatalogueConfiguration( String version, String updateSequence,
                            ...
                            Contents contents, FilterCapabilities filterCapabilities,
     ...
     * @param catalogDeegreeParams
     * @param systemId
     * @param ebrimCaps the specified ebrim extensions
     */
    CatalogueConfiguration( String version, String updateSequence,
                            ServiceIdentification serviceIdentification,
                            ServiceProvider serviceProvider, OperationsMetadata operationsMetadata,
                            Contents contents, FilterCapabilities filterCapabilities,
                            CatalogueDeegreeParams catalogDeegreeParams, URL systemId, EBRIMCapabilities ebrimCaps ) {
        super( version, updateSequence, serviceIdentification, serviceProvider, operationsMetadata,
               contents, filterCapabilities, ebrimCaps );
        this.catalogDeegreeParams = catalogDeegreeParams;
