 ...
 * 
 * @version 2.0, $Revision: 9501 $, $Date: 2008-01-10 10:41:39 +0100 (Thu, 10 Jan 2008) $
 * 
 * @since 2.0
 * 
 */
public class CatalogueCapabilitiesDocument extends OWSCommonCapabilitiesDocument {
    ...
    protected EBRIMCapabilities parseEBRIMCapabilities()
        ...
        List nl = XMLTools.getNodes( serviceFeature, "wrs:feature", nsContext );
    ...
    private Map<URI, List<String>> parsePropties( Node xmlNode )
                            throws XMLParsingException {
        List pnl = XMLTools.getNodes( xmlNode, "wrs:property", nsContext );
