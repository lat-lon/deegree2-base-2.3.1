//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/csw/manager/Harvest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Harvest extends AbstractOGCWebServiceRequest {
     ...
     */
    Harvest( String version, String id, Map<String,String> vendorSpecificParameter, 
             URI source, URI resourceType, String resourceFormat, 
             TimeDuration harvestTimeDuration, List<URI> responseHandler,
             Date startTimestamp ) {
