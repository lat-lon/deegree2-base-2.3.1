//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/csw/manager/ServiceHarvester.java $
/*----------------    FILE HEADER  ------------------------------------------
        ...
        public void run() {
            try {
                ...
                if ( repository.getLastHarvestingTimestamp( source ) == null ) {
                    ...
                    trans = createUpdateRequest( getID( metaData ), "smXML:fileIdentifier/smXML:CharacterString",
                                                 metaData );
                }
