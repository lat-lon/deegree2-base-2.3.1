...
abstract class AbstractManager implements Manager {
    ...
    /* (non-Javadoc)
     * @see org.deegree.ogcwebservices.csw.manager.Manager#init(org.deegree.ogcwebservices.wfs.WFService, org.deegree.ogcwebservices.csw.configuration.CatalogueConfiguration)
     */
    public void init( WFService wfsService, CatalogueConfiguration catalogueConfiguration ) throws MissingParameterValueException {
        ...
        try {
            ...
            String s = "If a CS-W is defined to handle Transaction and/or Harvest requests, XSLT scripts for request transformations (e.g. mapping the input schema to gml) must be defined in the deegreeParams section of the capabilities document. While trying to read an xslt script from: '" + url.toString()
