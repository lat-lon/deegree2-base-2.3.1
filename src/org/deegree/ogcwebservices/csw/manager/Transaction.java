//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/csw/manager/Transaction.java $
/*----------------    FILE HEADER  ------------------------------------------
...
import org.deegree.ogcwebservices.csw.discovery.GetRecordByIdDocument;
...
public class Transaction extends AbstractOGCWebServiceRequest {
     ...
     * specification
     * @param id uniquely identifies the given request
     * 
     * @param root the root of the xml-encoded transaction request
     * @return a Transaction with the values taken form the XML-Document.
     * @throws OGCWebServiceException if the Transaction could not be created
     */
