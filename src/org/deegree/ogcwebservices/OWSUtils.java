//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/OWSUtils.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class OWSUtils {
     ...
     * Get) <code>null</code> will be returned
     * 
     * @param capabilities
     * @param clss
     * @return see above
     ...
     * @param capabilities
     * @param clss
     * @return the first HTTPPost URL for a Operation within the pass capabilities document. If No
