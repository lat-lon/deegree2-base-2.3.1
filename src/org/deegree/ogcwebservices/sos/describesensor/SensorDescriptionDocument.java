//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/describesensor/SensorDescriptionDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SensorDescriptionDocument extends ComponentDescriptionDocument {
            ...
            for ( int d = 0; d < docs.length; d++ ) {
                ...
                if ( docs[d] != null ) {
                    ...
                    for ( int y = 0; y < nl.size(); y++ ) {
                        ...
                        List identifierList = XMLTools.getNodes( sensorNode, "sml:identifiedAs", nsContext );
                        ...
                        // get ClassifiedAs
                        List classifierList = XMLTools.getNodes( sensorNode, "sml:classifiedAs", nsContext );
                        ...
                        // get locatedUsing
                        List locationModelList = XMLTools.getNodes( sensorNode, "sml:locatedUsing", nsContext );
    ...
    private Document[] getSourceServerDocuments( SOSDeegreeParams dp, String[] typNames )
        ...
        while ( iter.hasNext() ) {
            ...
            List sensorIds = servers.get( key );
