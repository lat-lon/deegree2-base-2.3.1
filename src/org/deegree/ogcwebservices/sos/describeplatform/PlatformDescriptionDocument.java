//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/describeplatform/PlatformDescriptionDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
            ...
            for ( int d = 0; d < docs.length; d++ ) {
                ...
                if ( docs[d] != null ) {
                    ...
                    for ( int y = 0; y < nl.size(); y++ ) {
                        ...
                        // get identifiedAs
                        List identifierList = XMLTools.getNodes( platformNode, "sml:identifiedAs", nsContext );
                        ...
                        // get ClassifiedAs
                        List classifierList = XMLTools.getNodes( platformNode, "sml:classifiedAs", nsContext );
                        ...
                        // get locatedUsing
                        List locationModelList = XMLTools.getNodes( platformNode, "sml:locatedUsing", nsContext );
                        ...
                        for ( int i = 0; i < carriesList.size(); i++ ) {
                            String s = XMLTools.getRequiredNodeAsString( (Node) carriesList.get( i ),
