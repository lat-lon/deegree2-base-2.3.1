//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/describeplatform/DescribePlatformRequest.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DescribePlatformRequest extends AbstractOGCWebServiceRequest {
     ...
     * 
     */
    public static DescribePlatformRequest create( Map map )
                            throws OGCWebServiceException {
    ...
    public static DescribePlatformRequest create( String id, Document doc )
        ...
        try {
            ...
            for ( int i = 0; i < nl.size(); i++ ) {
                al.add( XMLTools.getRequiredNodeAsString( (Node) nl.get( i ), "text()", nsContext ) );
            }
