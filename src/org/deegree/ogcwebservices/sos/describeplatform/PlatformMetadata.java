//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/describeplatform/PlatformMetadata.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * represents the metadata of one platform; extends the representation of a generic component; uses
 * SensorML
 * 
...
public class PlatformMetadata extends ComponentMetadata {
     ...
     * @param carries
     */
    public PlatformMetadata( Identifier[] identifiedAs, Classifier[] classifiedAs,
                             EngineeringCRS hasCRS, LocationModel[] locatedUsing,
                             ComponentDescription describedBy, String attachedTo, String[] carries ) {
