//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/capabilities/SOSGetCapabilities.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SOSGetCapabilities extends GetCapabilities {
    ...
    public static SOSGetCapabilities create( String id, Document doc )
        ...
        try {
            ...
            // optional
            String updateSequence = XMLTools.getNodeAsString(
                                                              doc,
                                                              "ows:GetCapabilities/@updateSequence",
                                                              nsContext, null );

            // optional and unbounded
            String[] sections = XMLTools.getNodesAsStrings(
                                                            doc,
                                                            "ows:GetCapabilities/ows:Sections/ows:Section/text()",
                                                            nsContext );
    ...
    public SOSGetCapabilities( String id, String updateSequence, String[] acceptVersions,
                               String[] sections, String[] acceptFormats,
                               Map<String, String> vendoreSpec ) {
