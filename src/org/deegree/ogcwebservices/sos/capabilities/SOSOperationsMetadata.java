//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/sos/capabilities/SOSOperationsMetadata.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SOSOperationsMetadata extends OperationsMetadata {
    ...
    private static final long serialVersionUID = -3805760523604081523L;
     ...
     */
    public SOSOperationsMetadata( Operation getCapabilities, Operation describePlatform, Operation describeSensor,
    ...
    public Operation[] getOperations() {
        return new Operation[] { getCapabilitiesOperation, describePlatform, describeSensor, getObservation };
    }
