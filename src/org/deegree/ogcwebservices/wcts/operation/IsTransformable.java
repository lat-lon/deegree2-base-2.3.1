...
public class IsTransformable extends WCTSRequestBase {
     ...
     * @param version
     * @param id
     * @param sourceCRS if <code>null</code> it is assumed that the sourceCRS is not supported.
     * @param targetCRS if <code>null</code> it is assumed that the targetCRS is not supported.
    ...
    public IsTransformable( String version, String id, CoordinateSystem sourceCRS, CoordinateSystem targetCRS,
        ...
        if ( interpolationTypes != null ) {
            throw new IllegalArgumentException( Messages.getMessage( "WCTS_ISTRANSFORMABLE_INTERPOLATION_NOT_SUPPORTED" ) );
        }
