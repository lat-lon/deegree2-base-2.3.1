...
public class WCSRequestValidator {
    ...
    /**
     * validates the passed <tt>AbstractOGCWebServiceRequest</tt> which must be a request that is
     * known by a WCS against the passed <tt>WCSCapabilities</tt>
     * 
     * @param capabilities
     * @param request
    ...
    /**
     * @return true if the passed <tt>CodeList</tt> s contains the also passed codeSpace-value
     *         combination. Otherwise false will be returned
     * 
     * @param codeList
     * @param codeSpace
     * @param value
    ...
    private static boolean intersects( Envelope envelope, Code reqCRS, LonLatEnvelope llEnv )
