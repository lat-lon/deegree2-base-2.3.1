// $HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wcs/configuration/WCSConfigurationDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * $Revision: 10679 $, $Date: 2008-03-25 18:26:57 +0100 (Di, 25. Mär 2008) $
 */
public class WCSConfigurationDocument extends WCSCapabilitiesDocument {
    ...
    /**
     * creates the deegreeParams section of the WCS capabilities/configuration. If a 'common' WCS
     * capabilities is encapsulated by the <tt>WCSCapabilitieDocument</tt> this method returns
     * <tt>null</tt>
     * 
     * @return the data
