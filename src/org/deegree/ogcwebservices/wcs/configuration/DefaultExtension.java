// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wcs/configuration/DefaultExtension.java $
/*----------------    FILE HEADER  ------------------------------------------
    ...
    public void setType( String type )
        ...
        if ( type == null
             || ( !Extension.SHAPEINDEXED.equals( type ) && !Extension.NAMEINDEXED.equals( type )
                  && !Extension.FILEBASED.equals( type ) && !Extension.ORACLEGEORASTER.equals( type ) && !Extension.DATABASEINDEXED.equals( type ) ) ) {
