// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wcs/WCService.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WCService implements OGCWebService {
    ...
    private Resolution[] getResolutions( CoverageOffering co, GetCoverage request )
        ...
        Resolution[] res = extension.getResolutions( calcSpatialResolution( co, request ) );
    ...
    private Envelope calculateRequestEnvelope( GetCoverage request, String nativeCrs )
        ...
        Envelope result = gt.transform( envelope, CRSFactory.create( reqCrs ), true );
