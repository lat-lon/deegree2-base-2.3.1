// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wcs/XMLFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class XMLFactory extends org.deegree.ogcbase.XMLFactory {
    ...
    protected static void appendCoverageOffering( Element parent, CoverageOffering coverageOffering ) {
        ...
        if ( coverageOffering.getDescription() != null ) {
            XMLTools.appendElement( xmlNode, WCSNS, "description", coverageOffering.getName() );
        }
