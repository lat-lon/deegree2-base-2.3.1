// $HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcwebservices/wcs/describecoverage/InvalidCoverageDescriptionExcpetion.java $
/*----------------    FILE HEADER  ------------------------------------------
