...
public class J3DToCityGMLExporter implements J3DExporter {
    ...
    private void outputShape3D( Shape3D shape, Element parent, Transform3D transformation, boolean calcBounds,
        ...
        if ( app != null ) {
            ...
            if ( mat != null ) {
                // ambientIntensity = mat.getShininess();
    ...
    public static void main( String[] args ) {
        ...
        for ( int i = 0; i < args.length; i++ ) {
            ...
            if ( arg != null && !"".equals( arg.trim() ) ) {
                ...
                if ( arg.equalsIgnoreCase( "-?" ) || arg.equalsIgnoreCase( "-h" ) ) {
                    outputHelp();
                } else if ( "-inverseyz".equals( arg.toLowerCase() ) ) {
                    inverseYZ = true;
                } else {
                    if ( i + 1 < args.length ) {
                        String val = args[++i];
        ...
        try {
            ...
            J3DToCityGMLExporter converter = new J3DToCityGMLExporter( name, params.get( "-srs" ),
                                                                       params.get( "-buildingFunction" ), texDir,
                                                                       xTrans, yTrans, zTrans, rotAngle, asWFS,
                                                                       inverseYZ );
    ...
    private static void outputHelp() {
        ...
        sb.append( "[-inverseYZ] signal that the y and z coordinates should be inversed.\n" );
