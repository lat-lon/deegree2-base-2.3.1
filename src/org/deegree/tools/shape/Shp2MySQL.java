//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/tools/shape/Shp2MySQL.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Shp2MySQL {
    ...
    public void run()
        ...
        for ( int i = 0; i < fileList.size(); i++ ) {
            ...
            String outFile = fileList.get( i ) + ".sql";
            ...
            String tableName = sf.getFeatureByRecNo( 1 ).getFeatureType().getName().getPrefixedName().toUpperCase();
            ...
            for ( int j = 0; j < sf.getRecordNum(); j++ ) {
                ...
                for ( int k = 0; k < ftp.length; k++ ) {
                    ...
                    if ( o != null ) {
                        ...
                        names.append( name.getPrefixedName() );
    ...
    private String getCreateTableStatement( FeatureType ft ) {
        ...
        String name = ft.getName().getPrefixedName();
