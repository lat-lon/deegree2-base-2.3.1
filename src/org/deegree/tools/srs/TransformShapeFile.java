//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/tools/srs/TransformShapeFile.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class TransformShapeFile {
    ...
    private static void transformShapeFile( String inFile, String inCRS, String outFile, String outCRS )
        ...
        new ShapeFileWriter( result ).write( outFile );
