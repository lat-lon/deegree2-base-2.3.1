//$HeadURL: svn+ssh://developername@svn.wald.intevation.org/deegree/base/trunk/src/org/deegree/tools/datastore/DBSchemaToDatastoreConf.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 8049 $, $Date: 2007-08-23 10:19:28 +0200 (Do, 23 Aug 2007) $
 */
public class DBSchemaToDatastoreConf {
    ...
    /**
     * @return precision for a dBase numerical type
     * 
     * @param dbfType
     */
     ...
     * @throws IOException
     */
    private void printProperty( String tableName, String name, int type, String typeName, int precision, StringBuffer sb )
