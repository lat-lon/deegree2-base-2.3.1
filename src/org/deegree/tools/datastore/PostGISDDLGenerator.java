//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/tools/datastore/PostGISDDLGenerator.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Generator for PostGIS DDL (CREATE / DROP) operations to create PostGIS database schemas from
