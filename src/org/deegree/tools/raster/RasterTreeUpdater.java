//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/tools/raster/RasterTreeUpdater.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * The <code>RasterTreeUpdater</code> is a command line utility that can be used in addition to
 * the <code>RasterTreeBuilder</code> to update a previously generated raster tree.
 * 
...
public class RasterTreeUpdater {
    ...
    /**
     * Creates a new <code>RasterTreeUpdater</code> configured through the options contained in
    ...
    public static class RTUConfiguration {
        ...
        public RTUConfiguration( URL wcsConfiguration, List<String> updatedFiles, String coverageName, boolean verbose,
                                 Interpolation interpolation, int bitDepth, float quality, WorldFile.TYPE worldfileType ) {
