//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/enterprise/servlet/WPSHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WPSHandler extends AbstractOWServiceHandler implements ServiceDispatcher {
    ...
    private void sendExecuteResponse( HttpServletResponse httpResponse, ExecuteResponse executeResponse )
         ...
         * @see OGC 05-007r4 Table 27: If the �store� parameter is �false�, process execution was
