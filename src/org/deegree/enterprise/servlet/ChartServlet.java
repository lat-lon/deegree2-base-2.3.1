//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/enterprise/servlet/ChartServlet.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 13809 $, $Date: 2008-09-02 15:42:58 +0200 (Di, 02. Sep 2008) $
 */
public class ChartServlet extends HttpServlet {
     ...
     * @param request
     * @param response
     * @deprecated due to a typo this method is deprecated. Use
     *             {@link #performAction(HttpServletRequest, HttpServletResponse)} instead.
     */
    @Deprecated
    ...
    protected void performAction( HttpServletRequest request, HttpServletResponse response ) {
        ...
        /**
         * TODO introduce key "SOSURL" to point towards a SOS. 
         * In case a SOSURL is provided, the URL will be queried and it will be assumed that a 
         * GetObservation request is returned. 
         * 
         */
     ...
     * 
     * @param request
     * @return instance of the queuedMap
     * @throws IncorrectFormatException
     * @deprecated due to a typo this method is deprecated. Use {@link #initAndValidateParams(HttpServletRequest)}
     *             instead.
     * 
     */
    @Deprecated
    protected QueuedMap<String, String> InitNValidateParams( HttpServletRequest request )
                            throws IncorrectFormatException {
        return initAndValidateParams( request );
    }
