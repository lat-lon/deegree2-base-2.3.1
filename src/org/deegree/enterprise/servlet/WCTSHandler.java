...
/**
 * The <code>WCTSHandler</code> is the interface between the {@link WCTService} and the
 * {@link OGCServletController}.
 * <p>
 ...
 * </p>
 * <p>
 * Not supported is the the {@link GetTransformation} - Operation which --in our humble opinion-- is
 * just another {@link GetResoureceByID}.
 * </p>
 * 
...
public class WCTSHandler extends AbstractOWServiceHandler {
    ...
    /**
     * Outputs the given result to the servlet response object and sets the contentType to the given
     * contentType.
     * 
     * @param response
     *            to output to.
