// $HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/owscommon/XMLFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 13161 $, $Date: 2008-07-22 12:17:00 +0200 (Di, 22. Jul 2008) $
 */
public class XMLFactory extends org.deegree.ogcbase.XMLFactory {
    ...
    public static XMLFragment exportExceptionReport( ExceptionReport exr ) {
        ...
        for ( int i = 0; i < exr.getExceptions().length; i++ ) {
            ...
            Element e = XMLTools.appendElement( root, OWSNS, "ows:Exception", exc.getMessage() );
            if ( exc.getCode() != null ) {
    ...
    /**
     * Appends a <code>ows:Keywords</code> -element to the passed <code>Element</code> and fills it with the
     * available keywords.
     * 
     * @param xmlNode
     * @param keywords
    ...
    /**
     * Appends the DOM representation of the <code>OperationsMetadata</code>- section to the passed
     * <code>Element</code>.
     * 
     * @param root
     */
