 ...
 * 
 * @version $Revision: 1.1 $, $Date: 2007/03/09 10:40:46 $
 */
public class WPVSClientConfig {
    ...
    private WPVSClientConfig() throws SAXException, InvalidCapabilitiesException, IOException {
        ...
        WMS_GetMap_Fragment = clientOptions.getProperty( "WMS_GetMap_Fragment" );
        if ( WMS_GetMap_Fragment == null ) {
            LOG.logError( "The property WMS_GetMap_Fragment can not be found or has no value. Please insert it into the wpvsclient.properties." );
            throw new IllegalArgumentException(
                                                "The property WMS_GetMap_Fragment can not be found or has no value. Please insert it into the wpvsclient.properties." );
        }
