//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/common/control/AbstractSimplePrintListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * performs a print request/event by creating a PDF document from the current map. For this JASPER
 * is used. Well known parameters that can be passed to a jaser report are:<br>
 * <ul>
 * <li>MAP</li>
 * <li>LEGEND</li>
 * <li>DATE</li>
 ...
 * </ul>
 * <br>
 * Additionaly parameters named 'TA:XXXX' can be used. deegree will create a k-v-p for each TA:XXXX
 * passed as part of RPC.
 * 
 * 
...
public abstract class AbstractSimplePrintListener extends AbstractListener {
    ...
    /**
     * accesses the legend URLs passed, draws the result onto an image that are stored in a
     * temporary file. The name of the file will be returned.
     * 
     * @param legends
    ...
    /**
     * performs the GetMap requests passed, draws the result onto an image that are stored in a
     * temporary file. The name of the file will be returned.
     * 
     * @param list
     * @return filename of image file
    ...
    /**
     * stores the passed image in the defined temporary directory and returns the dynamicly created
     * filename
     * 
     * @param bi
     * @return filename of image file
    ...
    /**
     * returns legend access URLs for all visible layers of the passed view context. If a visible
     * layer does not define a LegendURL
     * 
     * @param vc
     * @return legend access URLs for all visible layers of the passed view context. If a visible
     *         layer does not define a LegendURL
     */
