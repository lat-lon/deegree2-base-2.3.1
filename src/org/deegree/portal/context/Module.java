//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/context/Module.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Module {
     ...
     * @param parameterList
     */
    public Module( String name, String content, boolean hidden, String type, int width, int height, String scrolling,
