// $HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/context/ViewContext.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ViewContext extends AbstractContext {
    ...
    public ViewContext clone( User user, String sessionID )
                            throws ParserConfigurationException, UnknownCRSException, IOException, XMLParsingException,
                            ContextException {
