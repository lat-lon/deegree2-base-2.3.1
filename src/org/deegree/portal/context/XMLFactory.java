//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/context/XMLFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * 
 * @version $Revision: 10791 $
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @author last edited by: $Author: rbezema $
 * 
 * @version $Revision: 10791 $, $Date: 2008-03-31 10:05:17 +0200 (Mon, 31 Mar 2008) $
 */
public class XMLFactory {
     ...
     * <code>namespace</code>. <p/> Note that the XML representation of a <code>Rectangle</code> is given by a
     ...
     * <code>namespace</code>. <p/> Note that the XML representation of a <code>GM_Point[]</code> is given by a
     ...
     * <code>namespace</code>. <p/> Note that the keywords are appended to a <code>&lt;KeywordList&gt;</code>
     * element.
     * 
     * @param toNode
     *            the <code>Node</code> to append the new element to
    ...
    /**
     * Appends the XML representation of a <code>BaseURL</code>, the <code>DescriptionURL</code>, to a
    ...
    /**
     * Appends the XML representation of a list of a <code>ViewContextCollection</code> to a <code>Node</code> using
    ...
    /**
     * Appends the XML representation of a list of a <code>ViewContextReference</code> to a <code>Node</code> using
     * the <code>namespace</code>. <p/> // TODO implement ID in VCR
     * 
     * @param toNode
     *            the <code>Node</code> to append the new element to
     * @param vcr
    ...
    /**
     * Appends the XML representation of a list of a <code>ModuleConfiguration</code> to a <code>Node</code> using
     * the <code>namespace</code>.
     * 
     * @param toNode
     *            the <code>Node</code> to append the new element to
    ...
    /**
     * Appends the XML representation of a list of a <code>MapOperationFactor</code> to a <code>Node</code> using
     * the <code>namespace</code>.
     * 
     * @param toNode
     *            the <code>Node</code> to append the new element to
