//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/context/WebMapContextFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Factory class for creating an instance of a web map Context (<tt>ViewContext</tt>). The
 ...
 * 
 * @version $Revision: 14504 $, $Date: 2008-10-28 14:42:40 +0100 (Di, 28. Okt 2008) $
 */
public class WebMapContextFactory {
    ...
    private static URL createOnlineResource( Element element )
        ...
        if ( element != null ) {
            ...
            // type = XMLTools.getAttrValue( element, CommonNamespaces.XLNNS, "type", null );
            // }
            // System.out.println( "document: " + new XMLFragment( element ).getAsPrettyString() );
            // System.out.println("Type is: " + type);
            if ( ( type != null ) && !"".equals( type ) && !type.equals( "simple" ) ) {
                throw new XMLParsingException( "unknown type of online resource: " + type );
            }

            // String tmp = XMLTools.getAttrValue( element, null, "href", null );
            String tmp = element.getAttributeNS( CommonNamespaces.XLNNS.toASCIIString(), "href" );

            // if ( tmp == null ) {
            // tmp = XMLTools.getAttrValue( element, CommonNamespaces.XLNNS, "href", null );
            // }

            // System.out.println("href is: " + tmp);
            try {
    ...
    /**
     * Creates a <tt>ContactInformation</tt>-instance according to the contents of the
     * DOM-subtree starting at the given 'ContactInformation'-<tt>Element</tt>.
     * <p>
     * 
     * @param element
    ...
    /**
     * Creates a <tt>ContactAddress</tt>-instance according to the contents of the DOM-subtree
     * starting at the given 'ContactAddress'-<tt>Element</tt>.
     * <p>
     * 
     * @param element
    ...
    /**
     * creates an instance of a class encapsulating the deegree specific extensions of the general
     * section of a web map context document
     * 
     * @param element
     *            <Extension>
     * @param xml
    ...
    private static GeneralExtension createGeneralExtension( Element element, XMLFragment xml )
        ...
        if ( element != null ) {
            ...
            ge = new GeneralExtension( ioSettings, frontend, mapParameter, authSettings, mode, layerTreeRoot );
        }
    ...
    /**
     * creates an instance of a class encapsulating access descrition to an authentification service
     * for a deegree map client
     * 
     * @param element
     *            <AuthentificationSettings>
    ...
    /**
     * creates an instance of a class encapsulating the frontend (GUI) description of a deegree map
     * client
     * 
     * @param element
     *            <Frontend>
    ...
    /**
     * creates a list of javascript pages (names) that contains javascript objects and methods that
    ...
    private static Module createModule( Element element )
        ...
        // <ModuleConfiguration>
        Element elem = XMLTools.getChildElement( "ModuleConfiguration", CommonNamespaces.DGCNTXTNS, element );
        ...
        return new Module( name, content, hidden, type, l, t, r, b, w, h, ov, head, close, scrollable, moduleJS, mc,
                           paramList );
    }
    ...
    private static ModuleConfiguration createModuleConfiguration( Element element )
        ...
        if ( element != null ) {
            Element elem = XMLTools.getRequiredChildElement( "OnlineResource", CommonNamespaces.DGCNTXTNS, element );
            URL onlineResource = createOnlineResource( elem );
    ...
    /**
     * creates an instance of a class encapsulating informations about controlling options for a map
    ...
    /**
     * returns a list of offered numerical map operation factors that can be used to determine zoom
     * or pan levels
     * 
     * @param element
    ...
    /**
     * creates an instance of a class encapsulating informations about the server (service) a layer
     * based on
     * 
     * @param element
     *            <Server>
    ...
    /**
     * creates a legendURL for a style/layer by evaluating the servers capabilities the layer is
     * servered by.
     * 
    ...
    private static ImageURL createLegendURL( String styleName, String layerName, Server server )
        ...
        if ( capa != null ) {
            ...
            if ( layer == null ) {
                throw new XMLParsingException( "LayerName: " + layerName + " does not exist in the WMSCapabilities" );
            }
            ...
            if ( urls != null && urls.length > 0 && urls[0] != null ) {
                ...
                if ( operation != null ) {
                    ...
                    GetLegendGraphic glg = GetLegendGraphic.create( "12", capa.getVersion(), layerName, styleName,
                                                                    null, null, 1, null, null, "image/jpeg", 20, 20,
                                                                    null, null );
                    try {
    ...
    private static LayerExtension createLayerExtension( Element element, User user, String sessionID )
        ...
        if ( element != null ) {
            ...
            if ( elem != null ) {
                ...
                /*
                 * double[] sc = getScaleHintFromCapabilities(mapServer, name); min = sc[0]; max =
                 * sc[1];
                 */
            }
            ...
            if ( elem != null ) {
                String s = XMLTools.getStringValue( elem );
                selectedForFI = "true".equals( s ) || "1".equals( s );
            }
            ...
            if ( elem != null ) {
                String s = XMLTools.getStringValue( elem );
                showLegendGraphic = "true".equals( s ) || "1".equals( s );
            }
            le = new LayerExtension( dataService, masterLayer, min, max, selectedForFI, ua, parentNodeId,
                                     showLegendGraphic );
    ...
    /**
     * returns the capabilities for the passed server. The capabilities are read directly from the
     * server or from the loacal cache.
     * 
     * @param url
     * @param service
     * @param version
     ...
     * @param sessionID
     * @param useAuthentication
     * @return he capabilities for the passed server. The capabilities are read directly from the
     *         server or from the loacal cache.
     */
