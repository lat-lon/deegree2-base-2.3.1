//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/context/WebMapContextFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WebMapContextFactory {
    ...
    /**
     * Creates a <tt>ContactInformation</tt>-instance according to the contents of the DOM-subtree starting at the
     * given 'ContactInformation'-<tt>Element</tt>.
     * <p>
     * 
     * @param element
    ...
    private static Module createModule( Element element )
        ...
        tmp = XMLTools.getAttrValue( element, null, "width", null );
        int w = 0;
        try {
        ...
        Module module = new Module( name, content, hidden, type, w, h, scrollable, moduleJS, mc, paramList );
    ...
    private static LayerExtension createLayerExtension( Element element, User user, String sessionID )
        ...
        if ( element != null ) {
            ...
            if ( elem != null ) {
                ...
                /*
                 * double[] sc = getScaleHintFromCapabilities(mapServer, name); min = sc[0]; max = sc[1];
                 */
            }
