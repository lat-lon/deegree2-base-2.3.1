//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/configuration/CSWClientConfiguration.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class CSWClientConfiguration {
    ...
    private String xPathToDataTitleFull = null;
    ...
    private String xPathToApplicationIdentifier = null;

    private String xPathToApplicationTitle = null;

    private String[] namespaceBindings = null;
