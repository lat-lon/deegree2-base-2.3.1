//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/configuration/CSWClientConfiguration.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class CSWClientConfiguration {
    ...
    /**
     * @param catalogName
     * @return Returns the address of the submitted catalog, or <tt>null</tt> if the map contains
     ...
     * @return Returns the format types of a given catalog, e.g. "ISO19115" or "ISO19119". May be
     ...
     * @param catalogName
     *            The name of the catalog
     * @return Returns the protocol type of a given catalog, e.g. "POST" or "SOAP". May be null, if
    ...
    /**
     * @param profileName
     * @return Returns the profiles to xsl for the passed profile or <tt>null</tt> if the profile
    ...
    /**
     * @param pathToDataTitleFull
     *            The xPathToDataTitleFull to set.
     */
    ...
    /**
     * @param profileName
     *            The name of the profile (ie: Profiles.ISO19115, Profiles.ISO19119,
     *            Profiles.OGCCORE)
