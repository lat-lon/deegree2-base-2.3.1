//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/InitCSWModuleListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class InitCSWModuleListener extends AbstractListener {
    ...
    protected void initConfig( CSWClientConfiguration config, ParameterList parList )
        ...
        config.setMapContextTemplatePath( extractMandatorySingleValue( parList,
                                                                       "mapContextTemplate" ) );
        ...
        config.setXPathToDataTitleFull( extractMandatorySingleValue( parList,
                                                                     "XPathToDataTitleFull" ) );

        // xPath in service catalog
        config.setXPathToServiceIdentifier( extractMandatorySingleValue( parList,
                                                                         "XPathToServiceId" ) );
        config.setXPathToServiceTitle( extractMandatorySingleValue( parList, "XPathToServiceTitle" ) );
        config.setXPathToServiceOperatesOnTitle( extractMandatorySingleValue( parList,
                                                                              "XPathToServiceOperatesOnTitle" ) );
        config.setXPathToServiceAddress( extractMandatorySingleValue( parList,
                                                                      "XPathToServiceAddress" ) );
        config.setXPathToServiceType( extractMandatorySingleValue( parList, "XPathToServiceType" ) );
        config.setXPathToServiceTypeVersion( extractMandatorySingleValue( parList,
     ...
     * @param paramList
     * @param parameter
     * @return Returns the value for the passed parameter. May return null, if the parameter is not
     *         part of the passed parameter list.
     */
    ...
    private String extractMandatorySingleValue( ParameterList paramList, String parameter )
        ...
        try {
            ...
            throw new CatalogClientException( Messages.getMessage( "IGEO_STD_CSW_MISSING_MAND_PARAM",
                                                                   parameter ) );
        }
        if ( value.startsWith( "'" ) && value.endsWith( "'" ) ) {
