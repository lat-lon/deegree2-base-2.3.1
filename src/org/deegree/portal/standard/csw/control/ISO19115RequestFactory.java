//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/ISO19115RequestFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * The only public method of the class receives a 'model' represented by a <tt>HashMap</tt> that
 ...
 * 
 * @version $Revision: 9457 $, $Date: 2008-01-08 12:04:29 +0100 (Tue, 08 Jan 2008) $
 */
public class ISO19115RequestFactory extends CSWRequestFactory {
    ...
    /**
     * takes RequestModel and builds a String result out of it. The result should be OGC
     * FilterEncoding conformant.
     * 
    ...
    /**
     * Build OGC Filterencoding fragment: use <code>CSWRequestmodel</code> field <b>fileIdentifier</b>
     * to create Comparison Operation.
     * 
    ...
    /**
     * Build OGC Filterencoding fragment: use <code>CSWRequestmodel</code> field
     * <b>parentIdentifier</b> to create Comparison Operation.
     * 
     ...
     * 
     * @return Returns the fragment for topiccategory. May be null, if no topiccategory is
     *         specified.
     */
    ...
    /**
     * Build OGC Filterencoding fragment: Split <code>CSWRequestmodel</code> field <b>keywords</b>
     * to one Comparison Operation for each keyword.
     * 
    ...
    /**
     * Build OGC Filterencoding fragment: use <code>dateFrom</code> and <code>dateTo</code> to
     * create Comparison Operations.
     * 
     * @return Returns the fragment for dates specified in the <code>RPCStruct</code>. May be
     *         null, if no dates are specified.
     */
    ...
    /**
     * Build OGC Filterencoding fragment: use <code>CSWRequestmodel</code> field <b>geographicBox</b>
     * to create Comparison Operation.
     * 
     * @return Returns the fragment for the geographic bounding box. May be empty, if no bounding
     *         box is specified.
     * @throws CatalogClientException
     * @throws UnknownCRSException
     */
