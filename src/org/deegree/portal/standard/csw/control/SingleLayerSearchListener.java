//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/SingleLayerSearchListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * A <code>${type_name}</code> class.<br/> This class handles a CSW metadata search request for a
 * single WMS layer. The layer for which to search the metedata needs to contain a MetadataURL tag
 * with the address of the corresponding CSW.
 * 
    ...
    public void actionPerformed( FormEvent event ) {
        ...
        if ( config == null ) {
            try {
                ...
                gotoErrorPage( Messages.getMessage( "IGEO_STD_CSW_ERROR_INIT_CSWCLIENT",
                                                    e.getMessage() ) );
