//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/DetailedSearchListener.java $
/*----------------    FILE HEADER  ------------------------------------------
        ...
        if ( dateFromMem != null ) {
            ...
            if ( st.getMember( Constants.RPC_YEAR ) != null ) {
                try {
                    ...
                    throw new CatalogClientException( Messages.getMessage( "IGEO_STD_CSW_INVALID_PARAM", Constants.RPC_YEAR ) );
                }
            }
            if ( st.getMember( Constants.RPC_MONTH ) != null ) {
                try {
                    ...
                    throw new CatalogClientException( Messages.getMessage( "IGEO_STD_CSW_INVALID_PARAM", Constants.RPC_MONTH ) );
                }
            }
            if ( st.getMember( Constants.RPC_DAY ) != null ) {
                try {
                    ...
                    throw new CatalogClientException( Messages.getMessage( "IGEO_STD_CSW_INVALID_PARAM", Constants.RPC_DAY ) );
                }
            }
        }
