//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/Constants.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Constants implements org.deegree.portal.Constants {
    ...
    static final String CONF_MDTYPE = "CONF_MDTYPE";
