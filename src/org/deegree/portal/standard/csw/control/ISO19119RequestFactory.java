//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/ISO19119RequestFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
                ...
                if ( ( t[i] != null ) && ( t[i].length() > 0 ) ) {
                    ...
                    for ( int k = 0; k < cf.length; k++ ) {
                        ...
                        if ( ( strOp != null ) && ( strOp.length() > 0 ) ) {
                            Operation op = createOperation( OperationDefines.PROPERTYISEQUALTO,
                                                            cf[k], strOp );
                            sb.append( op.toXML() );
                        }
                    }
