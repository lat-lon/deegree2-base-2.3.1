//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/csw/control/OverviewMetadataListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class OverviewMetadataListener extends SimpleSearchListener {
    ...
    protected void handleResult( Object result, String pathToXslFile, String metaVersion )
        ...
        while ( it.hasNext() ) {
            ...
            String xPathToTitle = getXPathToTitle( (Element) nl.get( 0 ) );
