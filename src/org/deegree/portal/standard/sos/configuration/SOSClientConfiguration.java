//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/sos/configuration/SOSClientConfiguration.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * enables access to the configuration parameters of the sos client. Mainly these are the names and
 * addresses of the sensor observation services to be called
 * 
