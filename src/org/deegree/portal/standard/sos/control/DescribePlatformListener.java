//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/sos/control/DescribePlatformListener.java $
        ...
        try {
            ...
            while ( iterator.hasNext() ) {
                ...
                String[] ids = XMLTools.getNodesAsStrings(
                                                           e,
                                                           "/sml:Platforms/sml:Platform/sml:identifiedAs/sml:Identifier",
                                                           nsContext );
                ...
                locatedUsing[0] = new GeoPositionModel( null, null, null, null, new EngineeringCRS( srcSRS ),
                                                        new GeographicCRS( refSRS ), new Object[0] );

                carries = XMLTools.getNodesAsStrings( e, "/sml:Platforms/sml:Platform/sml:carries/sml:Asset", nsContext );

                platformDescriptions[i] = new PlatformMetadata( identifiedAs, classifiedAs, engineerCRS, locatedUsing,
                                                                describedBy, attachedTo, carries );
