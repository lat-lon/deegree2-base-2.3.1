//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/wms/control/DynLegendListener.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12701 $, $Date: 2008-07-07 17:48:42 +0200 (Mo, 07. Jul 2008) $
 */
            ...
            if ( model[i].get( "LAYERS" ) != null ) {
                ...
                while ( st.hasMoreTokens() ) {
                    ...
                    if ( legendSymCache.get( path ) != null ) {
                        ...
                        LOG.logDebug( "DynLegendListener: read legendsymbol from cache for ", layer );
                    } else {
