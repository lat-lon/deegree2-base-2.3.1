//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/wms/control/RecenterToLayerListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This class sets the bounding box of the portal to the bounding box of one selected layer as it is
 * specified in the WMSCapabilities document of that layer.
 * 
 * If the ScaleHint of the layer reduces the visible part of the layer's LatLonBoundingBox, then a
 * new bounding box for this scale hint is calculated. Ohterwise the LatLonBoundingBox is used.
 * 
 * The chosen bounding box is transformed to the portals crs and the portals aspect ratio of width
 * and height.
 * 
