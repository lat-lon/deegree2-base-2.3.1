//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/wms/control/PrintListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class PrintListener extends AbstractMapListener {
     ...
     * @return
     */
    private HashMap<String,Object>[] modifyModelSize( Rectangle rectMap, HashMap<String,Object>[] model, int width, int height ) {
        int w = rectMap.width;
     ...
     * @throws UnknownCRSException
     */
    private BufferedImage getMap( HashMap<String,String>[] model )
        ...
        for ( int i = model.length - 1; i >= 0; i-- ) {
            ...
            String s = URLDecoder.decode( model[i].get( "FORMAT" ),
     ...
     * @return
     */
    private HashMap<String,Object> getLegend( RPCStruct struct, GetLegendGraphic glr, HashMap[] model ) {
