//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/wms/control/AbstractMapListener.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <ul>
 * <li><tt>ZoomInListener</tt> for handling zoomin actions. supported are zooming via point or
 * vie rectangle.
 ...
 * <li><tt>RecenterListener</tt> recenters the map to a specified point. This can be interpreted
 * as a special versio of zooming
 ...
 * </ul>
 * The user can additional listeners/action by extending the <tt>AbstractActionListener</tt> class
 * or one of the predefined listener.
 * <p>
 * </p>
 * Each Listerner have to be registered to the <tt>MapListener</tt> which is the class that will
 * be informed about each event/action within a map client. To register a class as listener it has
 * to stored within the MapListener.ConfigurationFile.
 * 
 * <p>
 * ---------------------------------------------------------------------
 * </p>
...
abstract class AbstractMapListener extends AbstractListener {
    ...
    /**
     * the method returns the scale of the map defined as diagonal size of a pixel at the center of
     * the map.
     */
