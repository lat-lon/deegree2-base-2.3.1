//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/standard/security/control/InitRoleEditorListener.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * This <code>Listener</code> reacts on 'initRoleGroupEditor' events and passes the roles to be
    ...
    public void actionPerformed( FormEvent event ) {
        ...
        try {
            ...
            getRequest().setAttribute( "MESSAGE",
                                       Messages.getMessage( "IGEO_STD_SEC_FAIL_INIT_ROLE_EDITOR",
                                                            e.getMessage() ) );
