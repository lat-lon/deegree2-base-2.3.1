//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/portal/portlet/portlets/WebMapPortlet.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class WebMapPortlet extends JspPortlet {
    ...
    /**
     * loads the ViewContext assigend to a portlet instance from the resource defined in the portles
     * configuration
     * 
