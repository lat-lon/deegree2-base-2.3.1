//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/shpapi/shape_new/ShapeFile.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * <code>ShapeFile</code> encapsulates and provides access to data and properties of a shapefile.
 * Please note that writing will probably fail if the data was read by shapefile.
 * 
...
public class ShapeFile {
     ...
     *            the base name
     */
    public ShapeFile( LinkedList<Shape> shapes, ShapeEnvelope envelope, DBaseFile dbf,
                      String baseName ) {
        this.shapes = shapes;
     ...
     */
    public ShapeFile( FeatureCollection fc, String baseName ) throws DBaseException,
                            GeometryException {
        this.baseName = baseName;
    ...
    private void createDBF( FeatureCollection fc )
        ...
        dbf = new DBaseFile( baseName,
                             descriptors.toArray( new FieldDescriptor[descriptors.size()] ) );
