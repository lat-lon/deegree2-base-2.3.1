//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/shpapi/ShapeFile.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12749 $, $Date: 2008-07-09 13:21:08 +0200 (Mi, 09. Jul 2008) $
 */
public class ShapeFile {
     ...
     * <p>
     * This contains the geometry as well as the attributes stored into the dbase file. The geometry
     * property will use a default name (app:GEOM).
     * 
     * @param RecNo
     ...
     * 
     * @param fc
     * @param n the number of the feature to get the properties for
