//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/ecwapi/ECWReader.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ECWReader {
    ...
    /**
     * read part from ECW-file which falls within env and return this part dimenions width and
     * height
     * 
     * @param fileName
