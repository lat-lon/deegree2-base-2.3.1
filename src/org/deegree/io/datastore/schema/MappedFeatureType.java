//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/schema/MappedFeatureType.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class MappedFeatureType extends DefaultFeatureType {
    ...
    MappedFeatureType( QualifiedName name, boolean isAbstract, PropertyType[] properties, String table,
                       ...
                       boolean isDeletable, boolean isInsertable ) {
