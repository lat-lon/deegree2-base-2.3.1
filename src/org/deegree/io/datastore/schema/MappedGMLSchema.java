//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/schema/MappedGMLSchema.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class MappedGMLSchema extends GMLSchema {
    ...
    protected MappedFeatureType buildFeatureType( ElementDeclaration element )
        ...
        return new MappedFeatureType( name, element.isAbstract(), properties, table, gmlId, this, isVisible,
                                      isUpdatable, isDeletable, isInsertable );
    }
