//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/schema/MappedGMLSchemaDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class MappedGMLSchemaDocument extends GMLSchemaDocument {
    ...
    private void parseGlobalAnnotations()
        ...
        try {
            ...
            LOG.logInfo( msg );
            try {
                datastoreClass = Class.forName( backend );
        ...
        try {
            Datastore ds = (Datastore) datastoreClass.newInstance();
    ...
    MappedSimplePropertyType parseMappedSimplePropertyType( Element element, QualifiedName propertyName, int type,
        ...
        try {
            ...
            // table relations
            List relationElements = XMLTools.getNodes( contentElement, "deegreewfs:Relation", nsContext );
    ...
    private MappingField parseMappingField( Element element, String defaultField, String defaultTable )
        ...
        mappingField = new MappingField( table, field.toUpperCase(), typeCode, auto );
    ...
    private MappedGMLId parseGMLIdDefinition( Element element, String table )
        ...
        List mappingFieldElementList = XMLTools.getRequiredNodes( element, "deegreewfs:MappingField", nsContext );
    ...
    private TableRelation parseTableRelation( Element element, String fromTable )
                            throws XMLParsingException {
        List fromMappingElements = XMLTools.getRequiredNodes( element, "deegreewfs:From/deegreewfs:MappingField",
                                                              nsContext );
        List toMappingElements = XMLTools.getRequiredNodes( element, "deegreewfs:To/deegreewfs:MappingField", nsContext );
