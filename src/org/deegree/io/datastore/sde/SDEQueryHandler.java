//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sde/SDEQueryHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SDEQueryHandler extends AbstractSDERequestHandler {
    ...
    private Collection<FeatureProperty> fetchRelatedProperties( QualifiedName propertyName, MappedPropertyType pt,
                                                                Map mappingFieldMap, Object[] resultValues ) {
