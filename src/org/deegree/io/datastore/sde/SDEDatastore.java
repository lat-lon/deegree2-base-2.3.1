//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sde/SDEDatastore.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 7468 $, $Date: 2007-06-05 16:33:13 +0200 (Tue, 05 Jun 2007) $
 */
public class SDEDatastore extends Datastore {
    ...
    public AnnotationDocument getAnnotationParser () {
        return new SQLAnnotationDocument (SDEDatastore.class);
    }    
