//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/postgis/PGgeometryAdapter.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class PGgeometryAdapter {
    ...
    public static Geometry wrap( PGgeometry pgGeometry, CoordinateSystem crs )
        ...
        default: {
            throw new GeometryException( "Cannot export PostGIS geometry of type '" + pgGeometry.getType()
