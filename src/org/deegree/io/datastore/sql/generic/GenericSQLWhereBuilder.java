//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/generic/GenericSQLWhereBuilder.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class GenericSQLWhereBuilder extends WhereBuilder {
    ...
    private void appendBBOXOperationAsSQL( StatementBuffer query, SpatialOperation operation )
        ...
        try {
            DBQuadtreeManager<?> qtm = new DBQuadtreeManager<Object>( jdbc, this.rootFts[0].getTable(), "geometry",
