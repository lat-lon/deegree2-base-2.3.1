//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/generic/GenericSQLDatastore.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * The spatial information is assumed to be stored in a BLOB field as a serialized deegree geometry.
 * It also will be assumed that a spatial index exists and that it has been created using deegree's
 * quadtree api.
 * 
...
public class GenericSQLDatastore extends AbstractSQLDatastore {
     ...
     * just considers the BBOX and non-spatial filter conditions.
     * 
