//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/AbstractRequestHandler.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class AbstractRequestHandler {
    ...
    private List<FeatureId> determineSuperFids( MappedFeatureType superFt, MappedFeaturePropertyType featureProp,
        ...
        try {
            ...
            rs = stmt.executeQuery();
            fids = extractFeatureIds( rs, superFt );
        } catch ( SQLException e ) {
     ...
     * 
     * @param concreteFt
     *            conrete (non-abstract) type that is contained in the feature property
     * @param relation
