//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/StatementBuffer.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class StatementBuffer {
    ...
    /**
     * Appends the given argument (as the replacement value for the '?' character in the query) to
     * the statement.
     * 
     * @param o
     * @param typeCode
