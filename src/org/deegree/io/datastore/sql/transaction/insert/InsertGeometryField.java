//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/transaction/insert/InsertGeometryField.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class InsertGeometryField extends InsertField {
     ...
     * @param targetSrs 
     */
    InsertGeometryField( InsertRow row, String columnName, int sqlType, Object value,
                               boolean isPK, int targetSrs ) {
