//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/datastore/sql/FeatureFetcher.java $
/*----------------    FILE HEADER  ------------------------------------------
...
abstract class FeatureFetcher extends AbstractRequestHandler {
     ...
     * @return the statement or null if the keys in resultValues contain NULL values
     */
    private StatementBuffer buildFeatureTypeSelect( TableRelation relation, Object[] resultValues, Map mappingFieldMap ) {
        StatementBuffer query = new StatementBuffer();
    ...
    /**
     * Determines a {@link SimpleContent} object that represents the queried {@link MappedGeometryProperty} in the
     * requested SRS.
     * <p>
     * <ul>
