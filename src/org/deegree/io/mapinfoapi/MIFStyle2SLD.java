...
public class MIFStyle2SLD {
     ...
     * @throws SAXException
     */
    public void insertSymbolStyle( Map<String, String> map, XMLFragment doc, String name )
        ...
        if ( map.size() == 5 ) {
            ...
            appendElement( e, SLDNS, SLD_PREFIX + ":Name", "default:" + name );
            appendElement( e, SLDNS, SLD_PREFIX + ":MinScaleDenominator", "0" );
            appendElement( e, SLDNS, SLD_PREFIX + ":MaxScaleDenominator", "" + MAX_VALUE );
     ...
     */
    public static void insertPenStyle( Map<String, String> map, XMLFragment doc, String name )
                            throws MalformedURLException, IOException, SAXException, XMLParsingException {
        ...
        appendElement( rule, SLDNS, SLD_PREFIX + ":Name", "default:" + name );
        appendElement( rule, SLDNS, SLD_PREFIX + ":MinScaleDenominator", "0" );
        appendElement( rule, SLDNS, SLD_PREFIX + ":MaxScaleDenominator", "" + MAX_VALUE );
     ...
     * @throws XMLParsingException
     */
    public static void insertTextStyle( Map<String, String> map, XMLFragment doc, String name )
                            throws XMLParsingException {
    ...
    public XMLFragment getStyle( Map<String, HashSet<HashMap<String, String>>> styles, String name ) {
        ...
        if ( symbols != null ) {
            for ( Map<String, String> map : symbols ) {
                try {
                    insertSymbolStyle( map, doc, name );
