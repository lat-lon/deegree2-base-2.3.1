//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/io/dbaseapi/DBaseFile.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DBaseFile {
    ...
    private void initDBaseFile()
        ...
        /*
         * // read the file type file_type = fixByte( rafDbf.readByte() ); // get the last update
         * date file_update_year = fixByte( rafDbf.readByte() ); file_update_month = fixByte(
         * rafDbf.readByte() ); file_update_day = fixByte( rafDbf.readByte() );
         */
    ...
    /**
     * creates the dbase file and writes all data to it if the file specified by fname (s.o.) exists
     * it will be deleted!
     * 
     * @throws IOException
     * @throws DBaseException
    ...
    /**
     * writes a data record to byte array representing the data section of the dBase file. The
     * method gets the data type of each field in recData from fieldDesc wich has been set at the
     * constructor.
     * 
     * @param recData
     * @throws DBaseException
     ...
     * writes a data record to byte array representing the data section of the dBase file. The
     * method gets the data type of each field in recData from fieldDesc wich has been set at the
     * constructor. index specifies the location of the retrieved record in the datasection. if an
     * invalid index is used an exception will be thrown
     * 
     * @param index
     * @param recData
     * @throws DBaseException
