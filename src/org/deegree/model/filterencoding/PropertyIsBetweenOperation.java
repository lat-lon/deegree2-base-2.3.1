//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/filterencoding/PropertyIsBetweenOperation.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class PropertyIsBetweenOperation extends ComparisonOperation {
    ...
    /**
     * Given a DOM-fragment, a corresponding Expression-object (for the LowerBoundary-element) is
     * built. This method recursively calls other buildFromDOM () - methods to validate the
    ...
    /**
     * Given a DOM-fragment, a corresponding Expression-object (for the UpperBoundary-element) is
     * built. This method recursively calls other buildFromDOM () - methods to validate the
     * structure of the DOM-fragment.
     * 
     * @throws FilterConstructionException
    ...
    /**
     * Calculates the <tt>PropertyIsBetween</tt> -Operation's logical value based on the certain
     * property values of the given <tt>Feature</tt>. TODO: Improve datatype handling.
     * 
     * @param feature
