//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/filterencoding/FilterTools.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * 
 * @version $Revision: 11350 $
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @author last edited by: $Author: rbezema $
 * 
 * @version 1.0. $Revision: 11350 $, $Date: 2008-04-22 13:50:31 +0200 (Tue, 22 Apr 2008) $
 * 
 * @since 2.0
 */
public class FilterTools {
    ...
    /**
     * Traverses the <tt>Filter</tt> -tree and returns the first BBOX-Operation that is found. Be aware of some
     * limitations, using a shape datastore, only very simple filters are supported, joins with or, and not are not
     * supported.
     * <p>
     * 
     * @param filter
    ...
    /**
     * Traverses the <tt>Filter</tt> -tree and returns all spatial filter operations. Their logical relationships are
     * ignored, because within the intended target context, only AND operations are possible.
     * 
     * @param filter
     *            search starts here
