//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/filterencoding/PropertyIsNullOperation.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Encapsulates the information of a <PropertyIsNull>-element (as defined in Filter DTD). The DTD
 * defines the properties type to be tested as PropertyName or Literal.
 * 
...
public class PropertyIsNullOperation extends ComparisonOperation {
    ...
    /**
     * Calculates the <tt>PropertyIsNull</tt> -Operation's logical value based on the certain
