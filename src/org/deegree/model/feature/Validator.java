//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/Validator.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Validator {
     ...
     * <p>
     * The feature instance is then assigned the corresponding {@link MappedFeatureType}. This also
     * applies to its subfeatures.
     * 
     * @param feature
    ...
    private void validate( Feature feature, FeatureProperty property, PropertyType pt )
        ...
        if ( pt instanceof SimplePropertyType ) {
            ...
            if ( !( value instanceof Geometry ) ) {
                String msg = Messages.format( "ERROR_WRONG_PROPERTY_TYPE", feature.getId(), pt.getName(),
                                              "GeometryProperty", value.getClass().getName() );
                throw new OGCWebServiceException( this.getClass().getName(), msg );
            }
            if ( LOG.getLevel() == ILogger.LOG_DEBUG ) {
                Geometry correctedGeometry = validateGeometryProperty( feature, (GeometryPropertyType) pt,
                                                                       (Geometry) value );
    ...
    /**
     * Validates that the given string value can be converted to the type of the given
    ...
    /**
     * Checks whether the outer boundary of the given {@link Surface} geometry has counter-clockwise
     * orientation and that the inner boundaries have clockwise orientation (as specified by ISO
     * 19107 / GML).
     * <p>
    ...
    /**
     * Checks whether the outer boundaries of the given {@link MultiSurface} members have
     * counter-clockwise orientation and that the inner boundaries have clockwise orientation (as
     * specified by ISO 19107 / GML).
     * <p>
     * Information on invalid orientations is logged.
     * 
     * @param feature
