//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/DefaultFeature.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DefaultFeature extends AbstractFeature implements Serializable {
    ...
    public FeatureProperty getDefaultProperty( PropertyPath path )
        ...
        if ( currentProperty == null ) {
            ...
            currentProperty = new DefaultFeatureProperty( list.get( list.size() - 1 ).getPropertyName(), null );
        }
