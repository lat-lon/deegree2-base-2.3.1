//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/schema/GMLSchema.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * especially the {@link FeatureType} definitions.
 * 
...
public class GMLSchema extends XMLSchema {
     ...
     * <p>
     * Read as: Is there only one concrete feature type that all instances of this type must have?
     * Or are there several possible concrete subtypes?
     * 
     * @param ft
     *            feature type to check
     * @return true, if the feature type has more than once concrete implementations, false
     *         otherwise
     */
