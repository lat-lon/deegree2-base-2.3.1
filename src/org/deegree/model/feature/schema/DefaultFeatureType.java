//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/schema/DefaultFeatureType.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class DefaultFeatureType implements FeatureType, Serializable {
    ...
    public GeometryPropertyType[] getGeometryProperties() {
        if ( this.geometryProperties == null ) {
            ...
            this.geometryProperties = (GeometryPropertyType[]) geometryPropertyList.toArray( this.geometryProperties );
