//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/DefaultFeatureCollection.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class DefaultFeatureCollection extends AbstractFeatureCollection implements Serializable {
    ...
    DefaultFeatureCollection( String id, Feature[] features, QualifiedName qName ) {
        super( id, qName );
        if ( features != null ) {
            collection = Arrays.asList( features );
        } else {
