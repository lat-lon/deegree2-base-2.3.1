//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/FeatureFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class FeatureFactory {
     ...
     * @param isAbstract
     *            <code>true</code> if the feature type to create is abstract, <code>false</code>
     *            otherwise
     * @param properties
     ...
     * @param value
     *            value of the <code>FeatureProperty</code>
     * @deprecated use {@link #createFeatureProperty (QualifiedName, Object)} instead
     */
    @Deprecated
