//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/GMLFeatureCollectionDocument.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * <p>
 * Extends {@link GMLFeatureDocument}, as a feature collection is a feature in the GML type
 * hierarchy.
 * <p>
 * 
...
public class GMLFeatureCollectionDocument extends GMLFeatureDocument {
     ...
     * </p>
     * <p>
     * Note, the featurecollection Document created with this constructor will return wfs-1.1 bound
     * FeatureCollections. If you want to return the same namespace bound feature collection as the
     * incoming feature collection, please use the
     * {@link #GMLFeatureCollectionDocument(boolean, boolean)}
     * </p>
     */
     ...
     * Creates a new instance of <code>GMLFeatureCollectionDocument</code>.
     * <p>
     * Instead of the other constructors, this one will be namespace aware of the incoming
     * featureCollection. This means, that the incoming top root element will hold it's namespace
     * binding and will not automatically be overwritten with the wfs:1.1 namespace binding.
     * </p>
     * 
     * @param guessSimpleTypes
     *            set to true, if simple types should be "guessed" during parsing
     * @param namespaceAware
     *            if true, the returned FeatureCollection will have the same namespace binding as
     *            the incoming FeatureCollection document. If set to false this constructor equals
     *            the {@link #GMLFeatureCollectionDocument(boolean)}.
     */
    public GMLFeatureCollectionDocument( boolean guessSimpleTypes, boolean namespaceAware ) {
