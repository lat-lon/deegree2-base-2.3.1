//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/feature/GMLFeatureAdapter.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 11349 $, $Date: 2008-04-22 13:49:42 +0200 (Tue, 22 Apr 2008) $
 */
public class GMLFeatureAdapter {
    ...
    private void exportProperty( Feature feature, FeatureProperty property, PrintWriter pw )
        ...
        if ( value instanceof Feature ) {
            ...
            if ( isReferenceType || ( exportedFeatures.contains( subfeature.getId() ) && !this.suppressXLinkOutput ) ) {
                pw.print( '<' );
                ...
                pw.print( propertyName.getPrefixedName() );
                pw.print( '>' );
                exportPropertyValue( subfeature, pw );
                pw.print( "</" );
                pw.print( propertyName.getPrefixedName() );
                pw.print( '>' );
            }
    ...
    private void exportPropertyValue( Object value, PrintWriter pw )
        ...
        if ( value instanceof Feature ) {
            ...
            // TODO: use (currently unavailable) property type information to determine correct
            // output format (e.g. xs:date, xs:time, xs:dateTime are all represented using Date
            // objects and cannot be differentiated at the moment)
