//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/coverage/grid/CompoundGridCoverageReader.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class CompoundGridCoverageReader extends AbstractGridCoverageReader {
    ...
    private GridCoverageReader createGridCoverageReader( File file )
        ...
        LonLatEnvelope lle = calcLonLatEnvelope( file.getEnvelope(), file.getCrs().getName() );
