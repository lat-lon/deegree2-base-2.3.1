//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/coverage/grid/AbstractGridCoverageWriter.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public abstract class AbstractGridCoverageWriter implements GridCoverageWriter {
     ...
     * {@link org.opengis.coverage.grid.GridCoverageExchange#getWriter} method. It can be a
