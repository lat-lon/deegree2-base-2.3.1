//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/coverage/grid/oracle/OracleGeoRasterGridCoverageReader.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * 
 * @version $Revision: 9436 $
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @author last edited by: $Author: rbezema $
 * 
 * @version 1.0. $Revision: 9436 $, $Date: 2008-01-08 11:50:19 +0100 (Tue, 08 Jan 2008) $
 * 
 * @since 2.0
 */
public class OracleGeoRasterGridCoverageReader extends AbstractGridCoverageReader {
     ...
     * 
     * @param jdbc
     *            description of the JDBC connection to a Orable DB
     * @param table
     *            name of the table storing the GeoRaster
     * @param column
     *            name of the column the target GeoRaster is stored
     * @param identification
     *            a SQL where clause that identifies the target georaster
     * @param description
     * @param envelope
     * @param format
     */
    public OracleGeoRasterGridCoverageReader( GeoRasterDescription grDesc,
                                              CoverageOffering description, Envelope envelope,
                                              Format format ) {
    ...
    private Object[] getImageRegion() {
        ...
        Envelope tmp = GeometryFactory.createEnvelope( lle.getMin().getX(), lle.getMin().getY(),
