//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/coverage/Coverage.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * Provides access to a coverage. The essential property of coverage is to be able to generate a
 ...
 * implement the {@link javax.media.jai.PropertySource} interface as well. In this case,
 * implementation of {@link javax.media.jai.PropertySource} methods must be consistent with
 * {@link #getMetadataNames} and {@link #getMetadataValue} methods.
 * 
...
public interface Coverage {
     ...
     * the coordinates used with the math transform
     * 
