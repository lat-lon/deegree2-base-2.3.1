//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/CurveImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class CurveImpl extends OrientableCurveImpl implements Curve, GenericCurve, Serializable {
     ...
     * @param crs
     */
    public CurveImpl( CurveSegment[] segments, CoordinateSystem crs ) throws GeometryException {
        this( '+', segments );
        this.crs = crs;
    }
    ...
    /**
     * returns the first point of the curve. if the curve doesn't contain a segment or the first
     ...
     *                a exception will be thrown if <tt>index</tt> is smaller than '0' or larger
     *                than <tt>getNumberOfCurveSegments()-1</tt>
     */
    ...
    public Object clone() {
        ...
        try {
            ...
            cs = segments.toArray( new CurveSegment[getNumberOfCurveSegments()] );
