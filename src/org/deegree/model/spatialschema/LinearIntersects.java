//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/LinearIntersects.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class LinearIntersects {
    ...
    public static boolean intersects( SurfacePatch surface1, SurfacePatch surface2, double tolerance )
        ...
        if ( LinearContains.contains( surface1, surface2, tolerance )
             || LinearContains.contains( surface2, surface1, tolerance ) ) {
            inter = true;
        }
