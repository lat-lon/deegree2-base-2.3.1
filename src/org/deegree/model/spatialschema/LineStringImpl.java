//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/LineStringImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class LineStringImpl extends CurveSegmentImpl implements LineString, Serializable {
     ...
     */
    public LineStringImpl( Position[] gmps, CoordinateSystem cs ) throws GeometryException {
        super( gmps, cs );
    }
