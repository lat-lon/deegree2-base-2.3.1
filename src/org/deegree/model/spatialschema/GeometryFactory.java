//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/GeometryFactory.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public final class GeometryFactory {
    ...
    /**
     * Creates a <tt>GM_Surface</tt> from the ordinates of the exterior ring and the the interior
     * rings
     * <p>
     * 
     * @param exterior
