//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/Aggregate.java $
/*----------------    FILE HEADER  ------------------------------------------
...
/**
 * 
 * This interface defines the basis functionallity of all geometry aggregations. it will be
 * specialized for the use of primitive, and solid geometries.
 * 
 * <p>
 * -----------------------------------------------------
 * </p>
...
public interface Aggregate extends Geometry {
    ...
    /**
     * inserts a Geometry in the aggregation. all elements with an index equal or larger index will
     * be moved. if index is larger then getSize() - 1 an exception will be thrown.
     * 
     * @param gmo
     *            Geometry to insert.
     * @param index
    ...
    /**
     * sets the submitted Geometry at the submitted index. the element at the position
     * <code>index</code> will be removed. if index is larger then getSize() - 1 an exception will
     * be thrown.
     * 
     * @param gmo
     *            Geometry to set.
    ...
    /**
     * removes the Geometry at the submitted index from the aggregation. if index is larger then
