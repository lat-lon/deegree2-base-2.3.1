//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/SurfaceImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class SurfaceImpl extends OrientableSurfaceImpl implements Surface, GenericSurface, Serializable {
     ...
     *             will be thrown if orientation is invalid
     */
    public SurfaceImpl( SurfacePatch[] surfacePatches, CoordinateSystem crs ) throws GeometryException {
        this( '+', surfacePatches );
        this.crs = crs;
    }
    ...
    private void calculateCentroidArea() {
        ...
        if ( area > 0 ) {
            ...
            // fall back
            centroid = GeometryFactory.createPoint( 0, 0, this.crs );
        }
    }
