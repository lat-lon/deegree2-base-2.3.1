//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/Geometry.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public interface Geometry extends Serializable {
    ...
    /**
     * translate a geometry by the submitted values. if the length of <tt>d</tt> is smaller then
     * the dimension of the geometry only the first d.length'th coordinates will be translated. If
     * the length of <tt>d</tt> is larger then the dimension of the geometry an
     * ArrayIndexOutOfBoundExceptions raises.
     */
