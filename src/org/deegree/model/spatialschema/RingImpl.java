//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/RingImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class RingImpl extends OrientableCurveImpl implements Ring, Serializable {
     ...
     * @throws GeometryException
     */
    public RingImpl( Position[] points, CoordinateSystem crs, char orientation ) throws GeometryException {
     ...
     * @throws GeometryException
     */
    public RingImpl( CurveSegment[] segments, CoordinateSystem crs, char orientation ) throws GeometryException {
        super( crs, orientation );
    ...
    protected void setPositions( Position[][] positions )
        ...
        segments = new CurveSegment[positions.length];
        for ( int i = 0; i < positions.length; i++ ) {
            segments[i] = new LineStringImpl( positions[i], getCoordinateSystem() );
        }
    ...
    /**
     * returns the CurveBoundary of the Ring. For a CurveBoundary is defines as the first and the
     * last point of a Curve the CurveBoundary of a Ring contains two indentical point (because a
     * Ring is closed)
     */
    ...
    /**
     * the operations returns true if the submitted multi primitive intersects with the curve
     * segment
     */
     ...
     * 
     * @param position
     * @return true if Ring contains passed position
     */
