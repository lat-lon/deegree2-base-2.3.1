//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/PositionImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class PositionImpl implements Position, Serializable {
     ...
     * 
     * @param other
     *            the Coordinates from which the position is build if <code>null</code> the
     *            default values 0,0,0 with a dim of 3 is assumed.
     */
    PositionImpl( final Point3d other ) {
        if ( other != null ) {
    ...
    /**
     * @return the position as a array the first field contains the x- the second field the y-value
     *         etc.
     * 
    ...
    /**
     * @return the accuracy the position is defined. The accuracy is measured in values of the CRS
