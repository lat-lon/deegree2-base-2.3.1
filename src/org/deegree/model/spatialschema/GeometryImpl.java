//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/GeometryImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * @version $Revision: 13564 $ $Date: 2008-08-11 18:26:17 +0200 (Mo, 11. Aug 2008) $
 */
...
public abstract class GeometryImpl implements Geometry, Serializable {
    ...
    protected double mute = 0.000000001;
    ...
    /**
     * @return a shallow copy of the geometry. this isn't realized at this level so a CloneNotSupportedException will be
     *         thrown.
     */
    @Override
    public Object clone()
    ...
    /**
     * The "intersection" operation shall return the set theoretic intersection of this <tt>Geometry</tt> and the
     * passed <tt>Geometry</tt>.
     * 
     * @param that
     *            the Geometry to intersect with
