//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/SurfacePatchImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * abstract because it should be specialized by derived classes <code>Polygon</code> for example
 * 
 * 
 ...
 */
abstract class SurfacePatchImpl implements GenericSurface, SurfacePatch, Serializable {
    ...
    /**
     * returns true if the calculated parameters of the Geometry are valid and false if they must be
     * recalculated
     */
     ...
     * 
     * @return exterior ring as Positions
     */
     ...
     * 
     * @return interior rings as Positions
     */
    ...
    public boolean equals( Object other ) {
        ...
        if ( !exteriorRing.getEnvelope().equals( ( (SurfacePatch) other ).getEnvelope() ) ) {
            return false;
        }

        // check positions of exterior ring
        Position[] pos1 = exteriorRing.getPositions();
    ...
    private void calculateCentroidArea() {
        ...
        if ( interiorRings != null ) {
            for ( int i = 0; i < interiorRings.length; i++ ) {
                ...
                tmp += dum;
                // TODO add correct centroid calculation
