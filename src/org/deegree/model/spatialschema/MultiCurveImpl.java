//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/MultiCurveImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
final class MultiCurveImpl extends MultiPrimitiveImpl implements MultiCurve, Serializable {
    ...
    /**
     * inserts a Curve in the aggregation. all elements with an index equal or larger index will be
     * moved. if index is larger then getSize() - 1 or smaller then 0 or gmc equals null an
     ...
     */
    public void insertCurveAt( Curve gmc, int index )
     ...
     */
    public void setCurveAt( Curve gmc, int index )
                            throws GeometryException {
    ...
    /**
     * removes the Curve at the submitted index from the aggregation. if index is larger then
