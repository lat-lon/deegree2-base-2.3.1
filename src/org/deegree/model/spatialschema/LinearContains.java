//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/LinearContains.java $
/*----------------    FILE HEADER  ------------------------------------------
...
class LinearContains {
    ...
    /**
     * the operation returns true if the submitted curve segment contains the submitted surface
     * patch
     * 
     * @param surface
     * @param curve
    ...
    /**
     * the operation returns true if polygon defined by an array of Position contains the submitted
     * point.
     * 
     * @param positions
     * @param point
