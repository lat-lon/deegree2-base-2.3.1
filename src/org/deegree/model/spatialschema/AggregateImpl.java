//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/spatialschema/AggregateImpl.java $
/*----------------    FILE HEADER  ------------------------------------------
...
abstract class AggregateImpl extends GeometryImpl implements Aggregate, Serializable {
     ...
     * be moved. if index is larger then getSize() - 1 or smaller then 0 or gmo equals null an
    ...
    /**
     * returns the Geometry at the submitted index. if index is larger then getSize() - 1 or smaller
