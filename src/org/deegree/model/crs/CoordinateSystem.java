//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/crs/CoordinateSystem.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * by a list containing 2 numbers. <br>
 * <br>
 ...
 * system, the list (91,91) does not correspond to a position. <br>
 * <br>
...
public class CoordinateSystem extends QualifiedName {
     ...
     * @param namespace
     * @deprecated use
     *             {@link #CoordinateSystem(org.deegree.crs.coordinatesystems.CoordinateSystem, String)}
     *             instead
     */
    @Deprecated
     ...
     * {@link org.deegree.crs.coordinatesystems.CoordinateSystem#getIdentifier()} which only returns
     * the first configured id.
     * 
    ...
    /**
     * Since the crs uses a different namespace system as {@link QualifiedName} this method only
     * returns the {@link #getIdentifier()}.
     */
    @Override
     ...
     * @deprecated this method returns the unit of the fist axis, assuming all axis have the same
     *             unit, which is not necessarily so. It is better to use the
     *             {@link  #getAxisUnits()} and iterate over all units.
     */
    @Deprecated
