//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/model/crs/GeoTransformer.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 11348 $, $Date: 2008-04-22 13:48:40 +0200 (Tue, 22 Apr 2008) $
 */
public class GeoTransformer {
    ...
    public GeoTransformer( String targetCRS ) throws UnknownCRSException, InvalidParameterException {
        ...
        targetCRSWrapper = new org.deegree.model.crs.CoordinateSystem( this.targetCRS, targetCRS );
    }
    ...
    public GridCoverage transform( AbstractGridCoverage coverage, Envelope targetBBOX, int dstWidth, int dstHeight,
        ...
        org.deegree.model.crs.CoordinateSystem targetMCRS = new org.deegree.model.crs.CoordinateSystem( targetCRS, null );
    ...
    public List<Point3d> transform( org.deegree.model.crs.CoordinateSystem sourceCRS, List<Point3d> points )
        ...
        try {
            trans = factory.createFromCoordinateSystems( sCRS, targetCRS );
