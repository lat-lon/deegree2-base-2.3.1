//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/configuration/PROJ4CRSProvider.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10994 $, $Date: 2008-04-09 16:58:16 +0200 (Wed, 09 Apr 2008) $
 * 
 */
...
public class PROJ4CRSProvider implements CRSProvider {
    ...
    public PROJ4CRSProvider( File f ) {
        ...
        try {
            ...
            LOG.logError( "Could not open file: " + f.getAbsoluteFile(), e );
            // e.printStackTrace();
        }
    }
    ...
    public CoordinateSystem getCRSByID( String id )
        ...
        if ( id != null && !"".equals( id.trim() ) ) {
            ...
            LOG.logDebug( "Given id: " + id + " converted into: " + tmpID );
            if ( coordinateSystems.containsKey( tmpID ) && coordinateSystems.get( tmpID ) != null ) {
                ...
                LOG.logDebug( "Trying  to create crs for given id: " + tmpID );
                ...
                if ( params.size() != 0 ) {
                    LOG.logInfo( "After creation of the crs with id: " + tmpID
                                 + ", following parameters remain unused: " + params );
                }
                idToParams.put( tmpID, null );
                return result;
            }
            LOG.logDebug( "No crs found with given id: " + id );
        }
        return null;
    }
    ...
    private CoordinateSystem createCRS( Map<String, String> params )
        ...
        if ( crsType == null || "".equals( crsType.trim() ) ) {
            LOG.logDebug( "The given params contain: " + params );
