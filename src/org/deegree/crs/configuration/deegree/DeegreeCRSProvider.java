//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/configuration/deegree/DeegreeCRSProvider.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 15120 $, $Date: 2008-11-26 16:00:17 +0100 (Mi, 26. Nov 2008) $
 * 
 */
    ...
    public DeegreeCRSProvider( Properties properties ) throws CRSConfigurationException {
        ...
        if ( getResolver() == null ) {
            ...
            if ( !"".equals( version ) ) {
                ...
                String className = "org.deegree.crs.deegree.configuration.CRSParser_" + version;
                try {
                    ...
                    className = "org.deegree.crs.deegree.configuration.CRSExporter_" + version;
                    ...
                    if ( constructor == null ) {
                        LOG.logError( "No constructor ( Properties.class ) found in class:" + className );
                    } else {
