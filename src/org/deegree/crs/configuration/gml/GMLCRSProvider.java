//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/configuration/gml/GMLCRSProvider.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class GMLCRSProvider extends AbstractCRSProvider<Element> {
     ...
     */
    protected Identifiable parseIdentifiedObject( Element rootElement )
                            throws XMLParsingException {
        if ( rootElement == null ) {
            return null;
        }
