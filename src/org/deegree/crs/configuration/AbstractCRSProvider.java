//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/configuration/AbstractCRSProvider.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public abstract class AbstractCRSProvider<T> implements CRSProvider {
    ...
    private static Map<String, Identifiable> cachedIdentifiables = new HashMap<String, Identifiable>( 42124 );
     ...
     */
    public synchronized <V extends Identifiable> V addIdToCache( V identifiable, boolean update ) {
