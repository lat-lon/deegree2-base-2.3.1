//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/configuration/CRSConfiguration.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 10991 $, $Date: 2008-04-09 16:52:13 +0200 (Wed, 09 Apr 2008) $
 * 
 */
    ...
    public synchronized static CRSConfiguration getCRSConfiguration()
        ...
        if ( is == null ) {
            ...
            if ( className == null || "".equals( className.trim() ) ) {
                ...
                provider = new DeegreeCRSProvider( null );
            } else if ( "org.deegree.crs.configuration.DeegreeCRSProvider".equals( className ) ) {
                LOG.logDebug( "The configured CRS provider is a Deegree CRSProvider with name: " + className );
                provider = new DeegreeCRSProvider( null );
            } else {
                ...
                try {
                    ...
                    if ( provider == null ) {
                        LOG.logInfo( "The configured class: " + className
