//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/crs/transformations/coordinate/ConcatenatedTransform.java $
/*----------------    FILE HEADER  ------------------------------------------
...
public class ConcatenatedTransform extends CRSTransformation {
     ...
     * (non-Javadoc)
     * 
     * @see org.deegree.crs.transformations.CRSTransformation#isIdentity()
     */
    @Override
