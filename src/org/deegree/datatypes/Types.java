//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/datatypes/Types.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12299 $, $Date: 2008-06-11 11:45:45 +0200 (Mi, 11. Jun 2008) $
 * 
 * @see java.sql.Types
 */
public final class Types {
     ...
     * {http://www.opengis.net/gml}:FeatureArrayPropertyType
     */
    ...
    public static int getJavaTypeForXSDType( String schemaTypeName )
        ...
        if ( "integer".equals( schemaTypeName ) || "int".equals( schemaTypeName ) || "long".equals( schemaTypeName ) )
