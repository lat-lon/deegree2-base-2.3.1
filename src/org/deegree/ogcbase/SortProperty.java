//$HeadURL: svn+ssh://aerben@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcbase/SortProperty.java $
/*----------------    FILE HEADER  ------------------------------------------
 ...
 * 
 * @version $Revision: 12551 $, $Date: 2008-06-26 12:00:58 +0200 (Do, 26. Jun 2008) $
 */
    ...
    public static SortProperty[] create( String sortBy, Map<String, URI> nscontext ) {
        ...
        if ( sortBy != null ) {
            ...
            for ( int i = 0; i < parts.length; i++ ) {
                ...
                PropertyPath pp = createPropertyPath( new QualifiedName( nameps[0], nameps[1],
                                                                         nscontext.get( nameps[0] ) ) );
