//$HeadURL: svn+ssh://jwilden@scm.wald.intevation.org/deegree/base/trunk/src/org/deegree/ogcbase/SortProperty.java $
/*----------------    FILE HEADER  ------------------------------------------
        ...
        if ( sortBy != null ) {
            ...
            for ( int i = 0; i < parts.length; i++ ) {
                ...
                if ( parts[i].endsWith( ":A" ) ) {
                    ...
                    String msg = "Invalid value '" + sortBy + "' for parameter 'SortBy'. Format of each list "
                                 + "item is metadata_element_name:A indicating an "
                                 + "ascending sort or metadata_element_name:D " + "indicating descending sort.";
                    throw new InvalidParameterValueException( msg );
                }
                // FIXME ASAP !!!
